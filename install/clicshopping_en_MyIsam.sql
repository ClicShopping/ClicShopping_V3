...
INSERT INTO `clic_configuration` VALUES(457, 'Do You want to receive an email alert for sold_out products  ?', 'STOCK_ALERT_PRODUCT_SOLD_OUT', 'false', 'An email alert will be sent if the stock is below 0 ?<br />', 9, 7, NULL, '1000-01-01 00:00:00', NULL, 'clic_cfg_set_boolean_value(array(\'true\', \'false\'))');
...
INSERT INTO `clic_configuration` VALUES(589, 'Do you want allow pre-order products if the authorization off stock purchases is True (under test)', 'PRE_ORDER_AUTORISATION', 'false', 'Si vous autorisez la pré-commande, the button sold_out product will not appear anymore and the customer will spend his pre-order.<br />', 9, 3, '2007-05-21 14:23:13', '2006-04-09 16:13:47', NULL, 'clic_cfg_set_boolean_value(array(\'true\', \'false\'))');
...
INSERT INTO `clic_configuration` VALUES(941, 'Do you want to display the stock ?', 'MODULE_FRONT_PAGE_NEW_PRODUCTS_DISPLAY_STOCK', 'none', 'Display an information In Stock,  Sold Out, out of stock ?', 6, 10, NULL, '2018-07-30 18:48:50', NULL, 'clic_cfg_set_boolean_value(array(\'none\', \'image\', \'number\'))');
...
INSERT INTO `clic_configuration` VALUES(960, 'Do you want to display the stock ?', 'MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_DISPLAY_STOCK', 'none', 'Display an information In Stock,  Sold Out, out of stock ?', 6, 10, NULL, '2018-07-30 21:35:37', NULL, 'clic_cfg_set_boolean_value(array(\'none\', \'image\', \'number\'))');
...
INSERT INTO `clic_configuration` VALUES(973, 'Do you want to display the stock ?', 'MODULE_PRODUCTS_LISTING_DISPLAY_STOCK', 'none', 'Display an information In Stock,  Sold Out, out of stock ?', 6, 6, NULL, '2018-07-30 21:38:26', NULL, 'clic_cfg_set_boolean_value(array(\'none\', \'image\', \'number\'),');
...
INSERT INTO `clic_configuration` VALUES(993, 'Do you want to display the stock ?', 'MODULE_PRODUCTS_SEARCH_DISPLAY_STOCK', 'none', 'Display an information In Stock,  Sold Out, out of stock ?', 6, 6, NULL, '2018-07-30 22:32:11', NULL, 'clic_cfg_set_boolean_value(array(\'none\', \'image\', \'number\'),');
...
INSERT INTO `clic_configuration` VALUES(1012, 'Do you want to display the stock ?', 'MODULE_PRODUCTS_NEW_DISPLAY_STOCK', 'none', 'Display an information In Stock,  Sold Out, out of stock ?', 6, 6, NULL, '2018-07-30 22:46:27', NULL, 'clic_cfg_set_boolean_value(array(\'none\', \'image\', \'number\'),');
...
INSERT INTO `clic_configuration` VALUES(1029, 'Do you want to display the stock ?', 'MODULE_PRODUCTS_SPECIAL_DISPLAY_STOCK', 'none', 'Display an information In Stock,  Sold Out, out of stock ?', 6, 6, NULL, '2018-07-30 22:48:57', NULL, 'clic_cfg_set_boolean_value(array(\'none\', \'image\', \'number\'),');
...
INSERT INTO `clic_configuration` VALUES(1084, 'Do you want to display this module ?', 'MODULE_PRODUCTS_INFO_GALLERY_BAGUETTEBOX_STATUS', 'True', 'Activate the module in your shop ?', 6, 1, NULL, '2018-07-31 11:12:56', NULL, 'clic_cfg_set_boolean_value(array(\'True\', \'False\'))');
INSERT INTO `clic_configuration` VALUES(1085, 'Please, select the content size', 'MODULE_PRODUCTS_INFO_GALLERY_BAGUETTEBOX_CONTENT_WIDTH', '4', 'Please, specif a number betwen 1 ad 12', 6, 1, NULL, '2018-07-31 11:12:56', NULL, 'clic_cfg_set_content_module_width_pull_down');
INSERT INTO `clic_configuration` VALUES(1086, 'Where do want to display the gallery position ?', 'MODULE_PRODUCTS_INFO_GALLERY_BAGUETTEBOX_POSITION', 'float-end', 'select the good value', 6, 2, NULL, '2018-07-31 11:12:56', NULL, 'clic_cfg_set_boolean_value(array(\'float-end\', \'float-start\', \'float-none\'))');
INSERT INTO `clic_configuration` VALUES(1087, 'Please select the width of the thumbail ?', 'MODULE_PRODUCTS_INFO_GALLERY_BAGUETTEBOX_THUMBAIL_WIDTH', '70', 'Please write a number in px', 6, 1, NULL, '2018-07-31 11:12:56', NULL, '');
INSERT INTO `clic_configuration` VALUES(1088, 'Please select the height of the thumbail ?', 'MODULE_PRODUCTS_INFO_GALLERY_BAGUETTEBOX_THUMBAIL_HEIGHT', '70', 'Please write a number in px', 6, 1, NULL, '2018-07-31 11:12:56', NULL, '');
...
INSERT INTO `clic_configuration` VALUES(1090, 'Do you want to display price discount in poucentage ?', 'MODULE_PRODUCTS_INFO_GALLERY_BAGUETTEBOX_POURCENTAGE', 'False', 'Display price discount in poucentage', 6, 1, NULL, '2018-07-31 11:12:56', NULL, 'clic_cfg_set_boolean_value(array(\'True\', \'False\'))');
INSERT INTO `clic_configuration` VALUES(1091, 'Sort Order', 'MODULE_PRODUCTS_INFO_GALLERY_BAGUETTEBOX_SORT_ORDER', '25', 'Sort Order (Lowest is displayed in first)', 6, 3, NULL, '2018-07-31 11:12:56', NULL, '');
...
INSERT INTO `clic_configuration` VALUES(1344, 'Please select the width for this modules', 'MODULE_CONTACT_US_FORM_CONTENT_WIDTH', '12', 'Indicate a number between 1 and 12', 6, 1, NULL, '2018-07-31 17:00:19', NULL, 'clic_cfg_set_content_module_width_pull_down');
