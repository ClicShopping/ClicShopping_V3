    ...
    <td>
      <table class="table table-sm table-hover table-striped">
        ...
        <tr class="dataTableHeadingRow">
          <th><?php echo $CLICSHOPPING_Customers->getDef('table_heading_number'); ?></th>
          <th><?php echo $CLICSHOPPING_Customers->getDef('table_heading_customers'); ?></th>
          <th class="text-md-right"><?php echo $CLICSHOPPING_Customers->getDef('table_heading_total_purchased'); ?>
            &nbsp;
          </th>
