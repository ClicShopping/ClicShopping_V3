  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          <div class="col-md-1 logoHeading"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . '/categories/client.gif', $CLICSHOPPING_Customers->getDef('heading_title'), '40', '40'); ?></div>
          <div class="col-md-3 pageHeading float-md-left"><?php echo '&nbsp;' . $CLICSHOPPING_Customers->getDef('heading_title'); ?></div>
          <div class="col-md-3">
...
?>
            <td class="text-md-center"><?php echo $CLICSHOPPING_Customers->getDef('table_heading_entry_email_validation'); ?></td>
            <td class="text-md-center"><?php echo $CLICSHOPPING_Customers->getDef('table_heading_country'); ?></td>
            <td class="text-md-center"><?php echo $CLICSHOPPING_Customers->getDef('table_heading_number_of_reviews'); ?></td>
...
?>
      <div class="row">
        <div class="col-md-12">
          <div class="col-md-6 float-md-left pagenumber hidden-xs TextDisplayNumberOfLink"><?php echo $Qcustomers->getPageSetLabel($CLICSHOPPING_Customers->getDef('text_display_number_of_link')); ?></div>
