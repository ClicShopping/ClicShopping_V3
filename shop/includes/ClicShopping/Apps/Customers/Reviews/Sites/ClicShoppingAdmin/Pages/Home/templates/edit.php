...
?>
  ...
  <div id="reviewsTab">
    <ul class="nav nav-tabs flex-column flex-sm-row" role="tablist" id="myTab">
      <li class="nav-item"><?php echo '<a href="#tab2" role="tab" data-toggle="tab" class="nav-link">' . $CLICSHOPPING_Reviews->getDef('tab_general'); ?></a></li>
    </ul>
      ...
      <div class="tab-content">
        ...
        <div class="adminformTitle">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="form-group row">
                <label for="<?php echo $CLICSHOPPING_Reviews->getDef('entry_products'); ?>" class="col-3 col-form-label"><?php echo $CLICSHOPPING_Reviews->getDef('entry_products'); ?></label>
                <div class="col-md-5">
          ...
          <div class="row">
            <div class="col-md-5">
              <div class="form-group row">
                <label for="<?php echo $CLICSHOPPING_Reviews->getDef('customers_name'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Reviews->getDef('customers_name'); ?></label>
                <div class="col-md-5">
          ...
          <div class="row">
            <div class="col-md-5">
              <div class="form-group row">
                <label for="<?php echo $CLICSHOPPING_Reviews->getDef('entry_date'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Reviews->getDef('entry_date'); ?></label>
                <div class="col-md-5">
                  <?php echo '<strong>' . DateTime::toLong($rInfo->date_added);  '</strong>'; ?>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-5">
              <div class="form-group row">
                <label for="<?php echo $CLICSHOPPING_Reviews->getDef('entry_status'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Reviews->getDef('entry_status'); ?></label>
                <div class="col-md-5">
...
<!-- //################################################################################################################ -->
        ...
        <div class="adminformTitle">
          <div class="row">
            <div class="col-md-5">
              <div class="form-group row">
                <label for="<?php echo $CLICSHOPPING_Reviews->getDef('entry_review'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Reviews->getDef('entry_review'); ?></label>
                <div class="col-md-7">
