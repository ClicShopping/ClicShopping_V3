...
?>
           <a onclick="$('delete').prop('action', ''); $('form').submit();"
              class="button"><span><?php echo HTML::button($CLICSHOPPING_Featured->getDef('button_delete'), null, null, 'danger'); ?></span></a>
         </span>
        </div>
      </div>
    </div>
    ...
    <td>
      <table class="table table-sm table-hover table-striped">
        ...
        <tr class="dataTableHeadingRow">
          ...
          <?php echo $CLICSHOPPING_Featured->getDef('table_heading_expires_date'); ?></td>
                ...
                <?php
                  if (isset($_POST['selected'])) {
                    ...
                    <input type="checkbox" name="selected[]"
                           value="<?php echo $Qfeatured->valueInt('products_featured_id'); ?>" checked="checked"/>
                    <?php
                  } else {
                    ?>
                    <input type="checkbox" name="selected[]"
                           value="<?php echo $Qfeatured->valueInt('products_featured_id'); ?>"/>
                    <?php
                  }
                ?>
              </td>
