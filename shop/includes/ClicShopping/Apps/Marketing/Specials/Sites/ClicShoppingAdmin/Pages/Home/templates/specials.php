...
?>
           <a onclick="$('delete').prop('action', ''); $('form').submit();"
              class="button"><span><?php echo HTML::button($CLICSHOPPING_Specials->getDef('button_delete'), null, null, 'danger'); ?></span></a>
         </span>
        </div>
      </div>
    </div>
    ...
    <td>
      <table class="table table-sm table-hover table-striped">
        ...
        <tr class="dataTableHeadingRow">
          ...
          ?>
          <th>
          <?php echo $CLICSHOPPING_Specials->getDef('table_heading_percentage'); ?></td>
          ...
          <?php echo $CLICSHOPPING_Specials->getDef('table_heading_expires_date'); ?></td>
          <th class="text-md-center">
          <?php echo $CLICSHOPPING_Specials->getDef('table_heading_flash_discount'); ?></td>
                ...
                <?php
                  if (isset($_POST['selected'])) {
                    ...
                    <input type="checkbox" name="selected[]"
                           value="<?php echo $Qspecials->valueInt('specials_id'); ?>"/>
                    <?php
                  }
                ?>
              </td>
