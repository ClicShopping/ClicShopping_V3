...
?>
  <div class="contentBody">
    <div class="row">
      <div class="col-md-12">
        <div class="card card-block headerCard">
          <div class="row">
            <span class="col-md-1 logoHeading"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . '/categories/products_options.gif', $CLICSHOPPING_Favorites->getDef('heading_title'), '40', '40'); ?></span>
    ...
    <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_Favorites->getDef('text_products_favorites') ; ?></strong></div>
