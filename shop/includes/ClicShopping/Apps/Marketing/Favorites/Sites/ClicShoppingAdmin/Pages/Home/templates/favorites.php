...
?>
          ...
          <th class="text-md-center"><?php echo $CLICSHOPPING_Favorites->getDef('table_heading_expires_date'); ?></td>
...
?>
                <input type="checkbox" name="selected[]" value="<?php echo $Qfavorites->valueInt('products_favorites_id'); ?>" />
<?php
      }
?>
              </td>
...
?>
              <td class="text-md-left"><?php echo $CLICSHOPPING_Currencies->format($Qfavorites->value('products_price')); ?></td>
<?php
...
?>
    <div class="row">
      <div class="col-md-12">
        <div class="col-md-6 float-md-left pagenumber hidden-xs TextDisplayNumberOfLink"><?php echo $Qfavorites->getPageSetLabel($CLICSHOPPING_Favorites->getDef('text_display_number_of_link')); ?></div>
        <div class="float-md-right text-md-right"> <?php echo $Qfavorites->getPageSetLinks(CLICSHOPPING::getAllGET(array('page', 'info', 'x', 'y'))); ?></div>
      </div>
    </div>
<?php
    } // end $listingTotalRow
