    ...
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span
            class="col-md-7 text-md-right"><?php echo HTML::button($CLICSHOPPING_AdministratorMenu->getDef('button_administrator_menu'), null, $CLICSHOPPING_AdministratorMenu->link('AdministratorMenu'), 'success'); ?></span>
        </div>
      </div>
    </div>
  </div>
