...
?>
  <div class="contentBody">
    ...
    <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_AdministratorMenu->getDef('text_administrator_menu') ; ?></strong></div>
...
<?php
  echo HTML::form('configure', CLICSHOPPING::link('index.php', 'A&Tools\AdministratorMenu&Configure'));
