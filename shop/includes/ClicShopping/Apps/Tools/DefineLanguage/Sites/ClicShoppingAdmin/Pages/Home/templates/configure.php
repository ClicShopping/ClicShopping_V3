    ...
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span
            class="col-md-7 text-md-right"><?php echo HTML::button($CLICSHOPPING_DefineLanguage->getDef('button_define_language'), null, $CLICSHOPPING_DefineLanguage->link('DefineLanguage'), 'success'); ?></span>
        </div>
      </div>
    </div>
  </div>
