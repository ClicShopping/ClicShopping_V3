 ...
 */
  ...
  class Delete extends \ClicShopping\OM\PagesActionsAbstract {
    ...
    public function execute() {
      ...
      static::removeMenu();
      static::removeProductsDefineLanguageDb();

      Cache::clear('menu-administrator');

      $CLICSHOPPING_MessageStack->add($CLICSHOPPING_DefineLanguage->getDef('alert_module_uninstall_success'), 'success', 'DefineLanguage');
