...
?>
  <div class="contentBody">
    ...
    <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_Backup->getDef('text_info_hadingg_restore_local'); ?></strong></div>
    <?php echo HTML::form('restore', $CLICSHOPPING_Backup->link('Backup&RestoreLocalNow'), 'post', 'enctype="multipart/form-data"'); ?>
    <div class="adminformTitle">
      <div class="row">
        <div class="separator"></div>
        <div class="col-md-12"><?php echo $CLICSHOPPING_Backup->getDef('text_info_restore_local') . '<br /><br />' . $CLICSHOPPING_Backup->getDef('text_info_best_through_https'); ?><br/><br/></div>
        <div class="separator"></div>
