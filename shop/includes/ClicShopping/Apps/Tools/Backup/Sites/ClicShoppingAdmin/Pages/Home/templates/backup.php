    ...
    <td>
      <table class="table table-sm  table-hover table-striped">
        ...
        <tr class="dataTableHeadingRow">
          ...
          <th
            class="dataTableHeadingContent text-md-center"><?php echo $CLICSHOPPING_Backup->getDef('table_heading_file_date'); ?></th>
          <th
            class="dataTableHeadingContent text-md-right"><?php echo $CLICSHOPPING_Backup->getDef('table_heading_file_size'); ?></th>
          <th
            class="dataTableHeadingContent text-md-right"><?php echo $CLICSHOPPING_Backup->getDef('table_heading_info_compression'); ?></th>
          <th
            class="dataTableHeadingContent text-md-right"><?php echo $CLICSHOPPING_Backup->getDef('table_heading_action'); ?>
            &nbsp;
          </th>
        </tr>
        </thead>
