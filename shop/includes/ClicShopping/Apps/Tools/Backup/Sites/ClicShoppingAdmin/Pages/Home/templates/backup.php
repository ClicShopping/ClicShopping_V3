      ...
      <td>
        <table class="table table-sm  table-hover table-striped">
          ...
          <tr class="dataTableHeadingRow">
            ...
            <th class="dataTableHeadingContent text-md-center"><?php echo $CLICSHOPPING_Backup->getDef('table_heading_file_date'); ?></th>
            <th class="dataTableHeadingContent text-md-right"><?php echo $CLICSHOPPING_Backup->getDef('table_heading_file_size'); ?></th>
            <th class="dataTableHeadingContent text-md-right"><?php echo $CLICSHOPPING_Backup->getDef('table_heading_info_compression'); ?></th>
            <th class="dataTableHeadingContent text-md-right"><?php echo $CLICSHOPPING_Backup->getDef('table_heading_action'); ?>&nbsp;</th>
          </tr>
          </thead>
          <tbody>
<?php
...
?>
                <th scope="row" onclick="document.location.href='<?php echo $CLICSHOPPING_Backup->link($onclick_link); ?>'"><?php echo $entry; ?></th>
                <td class="text-md-center" onclick="document.location.href='<?php echo $CLICSHOPPING_Backup->link($onclick_link); ?>'"><?php echo date($CLICSHOPPING_Backup->getDef('php_date_time_format'), filemtime($backup_directory . $entry)); ?></td>
                <td class="text-md-right" onclick="document.location.href='<?php echo $CLICSHOPPING_Backup->link($onclick_link); ?>'"><?php echo number_format(filesize($backup_directory . $entry)); ?> bytes</td>
