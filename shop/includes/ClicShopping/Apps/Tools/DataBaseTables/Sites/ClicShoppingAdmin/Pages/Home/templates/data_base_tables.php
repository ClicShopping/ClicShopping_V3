    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card card-block headerCard">
          <div class="row">
            <span class="col-md-1"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . '/categories/database_analyse.gif', $CLICSHOPPING_DataBaseTables->getDef('heading_title'), '40', '40'); ?></span>
            <span class="col-md-5 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_DataBaseTables->getDef('heading_title'); ?></span>
...
?>
      <span  class="col-md-6 text-md-right"><?php echo HTML::button($CLICSHOPPING_DataBaseTables->getDef('button_back'), null, $CLICSHOPPING_DataBaseTables->link('DataBaseTables'), 'primary'); ?></span>
<?php
    } else {

?>
            <span class="col-md-2 text-md-right runUtf8"><?php echo HTML::selectMenu('action', $actions, '', 'id="sqlActionsMenu"') . '<span class="runUtf8" style="display: none;">&nbsp;' . HTML::selectMenu('from_charset', $mysql_charsets) . '</span>'; ?></span>
            <span class="col-md-4 text-md-right"><?php echo HTML::button($CLICSHOPPING_DataBaseTables->getDef('button_update'), null, null, 'success'); ?></span>
<?php
    }
  }
?>
