    ...
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span class="col-md-6 text-md-right"><?php echo '<span>' . HTML::button($CLICSHOPPING_ServiceAPP->getDef('button_service_shop'), null,  $CLICSHOPPING_ServiceAPP->link('ServiceAPP'), 'success') . '</span>'; ?>
        </div>
      </div>
    </div>
  </div>
