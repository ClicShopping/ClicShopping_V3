      ...
      <div class="col-md-12">
        <div class="card card-block headerCard">
          <div class="row">
            ...
            <span class="col-md-7 pageHeading"><?php echo  $CLICSHOPPING_SecDirPermissions->getDef('heading_title'); ?></span>
          </div>
        </div>
      </div>
    </div>
...
?>
            <tr>
              <th scope="row"><?php echo substr($file['name'], strlen( CLICSHOPPING::getConfig('dir_root', 'Shop'))); ?></th>
              <td class="text-md-center"><?php echo $file['writable'] === true ? '<i class="fas fa-check fa-lg" aria-hidden="true"></i>' : '<i class="fas fa-times fa-lg" aria-hidden="true"></i>'; ?></td>
              <td class="text-md-center"><?php echo (in_array(substr($file['name'], strlen(CLICSHOPPING::getConfig('dir_root', 'Shop'))), $whitelist_array) ? '<i class="fas fa-check fa-lg" aria-hidden="true"></i>' : '<i class="fas fa-times fa-lg" aria-hidden="true"></i>'); ?></td>
            </tr>
<?php
    }
  }
