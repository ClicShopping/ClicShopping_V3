...
?>
  <form name="CustomersCustomersConfigure" action="<?php echo $CLICSHOPPING_SecurityCheck->link('Configure&Process&module=' . $current_module); ?>" method="post">
...
<?php
    ...
    if ($CLICSHOPPING_SecurityCheck->getConfigModuleInfo($current_module, 'is_uninstallable') === true) {
      echo '<span class="float-md-right">' . HTML::button($CLICSHOPPING_SecurityCheck->getDef('button_dialog_uninstall'), null, '#', 'warning', ['params' => 'data-toggle="modal" data-target="#ppUninstallModal"']) . '</span>';
    }
?>
    </div>
  </form>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><?php echo $CLICSHOPPING_SecurityCheck->getDef('dialog_uninstall_title'); ?></h4>
            </div>
            ...
            <div class="modal-footer">
              ...
              <?php echo HTML::button($CLICSHOPPING_SecurityCheck->getDef('button_cancel'), null, '#', 'warning',  ['params' => 'data-dismiss="modal"']); ?>
            </div>
          </div>
        </div>
      </div>
...
?>
   <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_SecurityCheck->getConfigModuleInfo($current_module, 'title'); ?></strong></div>
      <div class="adminformTitle">
        <div class="row">
          <div class="separator"></div>
          <div class="col-md-12">
