      ...
      <div class="col-md-12">
        <div class="card card-block headerCard">
          <div class="row">
            ...
            <span class="col-md-5 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_EditLogError->getDef('heading_title'); ?></span>
    ...
    <table class="table table-sm table-hover table-striped">
      <thead>
        <tr class="dataTableHeadingRow">
          ...
          <th class="text-md-right"><?php echo $CLICSHOPPING_EditLogError->getDef('table_heading_filesize'); ?></th>
          <th class="action"></th>
        </tr>
      </thead>
      <tbody>
...
?>
        <tr>
          ...
          <td class="text-md-right"><?php echo $f['size']; ?></td>
          <td class="text-md-right"><?php echo HTML::link($CLICSHOPPING_EditLogError->link('Edit&View&log=' . $f['key']), HTML::image($CLICSHOPPING_Template->getImageDirectory() . 'icons/edit.gif', $CLICSHOPPING_EditLogError->getDef('icon_edit'))); ?></td>
        </tr>
<?php
    }
?>
