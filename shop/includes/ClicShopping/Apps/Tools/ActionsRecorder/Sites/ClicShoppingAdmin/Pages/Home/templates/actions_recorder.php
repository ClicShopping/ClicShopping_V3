  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card card-block headerCard">
        ...
        <div class="row">
          <span class="col-md-1 logoHeading"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . '/categories/modules_action_recorder.gif', $CLICSHOPPING_ActionsRecorder->getDef($CLICSHOPPING_ActionsRecorder->getDef('heading_title')), '40', '40'); ?></span>
          <span class="col-md-6 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_ActionsRecorder->getDef('heading_title'); ?></span>
...
?>
        <tr>
          <th scope="row" class="text-md-center"><?php echo (($Qactions->value('success') === 1) ? '<i class="fas fa-check fa-lg" aria-hidden="true"></i>' : '<i class="fas fa-times fa-lg" aria-hidden="true"></i>'); ?></th>
...
?>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="col-md-6 float-md-left pagenumber hidden-xs TextDisplayNumberOfLink"><?php echo $Qactions->getPageSetLabel($CLICSHOPPING_ActionsRecorder->getDef('text_display_number_of_link')); ?></div>
      <div class="float-md-right text-md-right"> <?php echo $Qactions->getPageSetLinks((isset($_POST['module']) && in_array($_POST['module'], $modules_array) && is_object($GLOBALS[$_POST['module']]) ? 'module=' . $_POST['module'] : null) . '&' . (isset($_POST['search']) && !empty($_POST['search']) ? 'search=' . $_POST['search'] : null)); ?></div>
    </div>
  </div>
</div>