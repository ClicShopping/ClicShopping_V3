...
?>
            <a onclick="$('delete').prop('action', ''); $('form').submit();"
               class="button"><span><?php echo HTML::button($CLICSHOPPING_Newsletter->getDef('button_delete'), null, null, 'danger'); ?></span></a>
           </span>
        </div>
      </div>
    </div>
...
// Permettre l'affichage des groupes en mode B2B
                ...
                <?php
                  if (isset($_POST['selected'])) {
                    ...
                    <input type="checkbox" name="selected[]"
                           value="<?php echo $Qnewsletters->valueInt('newsletters_id'); ?>" checked="checked"/>
                    <?php
                  } else {
                    ?>
                    <input type="checkbox" name="selected[]"
                           value="<?php echo $Qnewsletters->valueInt('newsletters_id'); ?>"/>
                    <?php
                  }
                ?>
              </td>
              ...
              <td
                class="text-md-center"><?php echo number_format($Qnewsletters->value('content_length')) . ' bytes'; ?></td>
