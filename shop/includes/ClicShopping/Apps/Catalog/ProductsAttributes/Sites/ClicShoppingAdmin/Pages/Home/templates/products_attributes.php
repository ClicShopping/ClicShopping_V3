...
?>
    <div class="row">
      <div class="col-md-12">
        <div class="card card-block headerCard">
          <div class="row">
            <span class="col-md-1 logoHeading"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . '/categories/products_options.gif', CLICSHOPPING::getDef('heading_title'), '40', '40'); ?></span>
            <span class="col-md-4 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_ProductsAttributes->getDef('heading_title'); ?></span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="categoriesTabs" style="overflow: auto;">
      <ul class="nav nav-tabs flex-column flex-sm-row" role="tablist"  id="myTab">
        <li class="nav-item"><?php echo '<a href="#tab1" role="tab" data-toggle="tab" class="nav-link active">' . $CLICSHOPPING_ProductsAttributes->getDef('tab_step1') . '</a>'; ?></li>
        <li class="nav-item"><?php echo '<a href="#tab2" role="tab" data-toggle="tab" class="nav-link">' . $CLICSHOPPING_ProductsAttributes->getDef('tab_step2') . '</a>'; ?></li>
        <li class="nav-item"><?php echo '<a href="#tab3" role="tab" data-toggle="tab" class="nav-link">' . $CLICSHOPPING_ProductsAttributes->getDef('tab_step3'); ?></a></li>
        <li class="nav-item"><?php echo '<a href="#tab4" role="tab" data-toggle="tab" class="nav-link">' . $CLICSHOPPING_ProductsAttributes->getDef('tab_step4'); ?></a></li>
    </ul>
...
?>
                    <tr>
                      <td colspan="3"><br /><?php echo $CLICSHOPPING_ProductsAttributes->getDef('text_warning_of_delete'); ?></td>
                    </tr>
                    <tr>
                      <td colspan="3" class="text-md-right"><br /><?php echo HTML::button($CLICSHOPPING_ProductsAttributes->getDef('button_cancel'), null, $CLICSHOPPING_ProductsAttributes->link('ProductsAttributes&' . $page_info), 'warning', null, 'sm'); ?></td>
                    </tr>
<?php
    } else {
?>
...
?>
                    <div class="row">
                      <div class="col-md-12">
                      <div class="col-md-6 float-left pagenumber hidden-xs TextDisplayNumberOfLink"><?php echo $QoptionValues->getPageSetLabel($CLICSHOPPING_ProductsAttributes->getDef('text_display_number_of_link')); ?></div>
...
?>
            <tbody>
              <tr>
                <td width="100%"><table class="table table-sm">
<?php
...
?>
                <div class="row">
                  <div class="col-md-12">
                    <div class="col-md-6 float-left pagenumber hidden-xs TextDisplayNumberOfLink"><?php echo $Qvalues->getPageSetLabel($CLICSHOPPING_ProductsAttributes->getDef('text_display_number_of_link')); ?></div>
...
?>
                    <td class="text-md-right"><?php echo $CLICSHOPPING_ProductsAttributes->getDef('table_heading_opt_b2b'); ?></td>
<?php
  } else {
?>
                    <td></td>
...
?>
                  <td class="text-md-right"><strong><?php echo $Qattributes->valueDecimal('options_values_price'); ?></strong></td>
                  <td class="text-md-center"><strong><?php echo $Qattributes->value('price_prefix'); ?></strong></td>
                  <td class="text-md-center"><strong><?php echo $Qattributes->valueInt('products_options_sort_order'); ?></strong></td>
...
?>
            <div class="row">
              <div class="col-md-12">
                <div class="col-md-6 float-left pagenumber hidden-xs TextDisplayNumberOfLink"><?php echo $Qattributes->getPageSetLabel(CLICSHOPPING::getDef('text_display_number_of_link')); ?></div>
...
?>
          <div class="tab-pane" id="tab4">
            ...
            <div class="mainTitle"><?php echo $CLICSHOPPING_ProductsAttributes->getDef('heading_title_clone_products_attributes'); ?></div>
                <table class="table table-sm table-hover table-striped">
                  <tr valign="middle">
                      <td class="text-md-center" width="20%"><?php echo $CLICSHOPPING_ProductsAttributes->getDef('clone_products_from'); ?>
...
<?php
 ...
 ?>
                      ...
                      <td colspan="2" valign="middle" width="5%"><?php echo $CLICSHOPPING_ProductsAttributes->getDef('clone_products_to'); ?></td>
                      <td width="20%">
