...
<div class="contentBody">
  ...
  <?php
    if ($CLICSHOPPING_Preview_Config->is_installed === true) {
      ?>
      <form name="CatalogPreviewConfigure"
            action="<?php echo $CLICSHOPPING_Preview->link('Configure&Process&module=' . $current_module); ?>"
            method="post">
      ...
      <div class="col-md-12 mainTitle">
        <strong><?php echo $CLICSHOPPING_Preview->getConfigModuleInfo($current_module, 'title'); ?></strong></div>
      <div class="adminformTitle">
        <div class="row">
          <div class="separator"></div>
          <div class="col-md-12">
