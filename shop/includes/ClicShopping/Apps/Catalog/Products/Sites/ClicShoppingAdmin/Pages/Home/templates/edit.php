...
?>
    ...
    <div id="productsTabs" style="overflow: auto;">
      <ul class="nav nav-tabs flex-column flex-sm-row" role="tablist"  id="myTab">
        ...
        <li class="nav-item"><?php echo '<a href="#tab4" role="tab" data-toggle="tab" class="nav-link">' . $CLICSHOPPING_Products->getDef('tab_description'); ?></a></li>
        <li class="nav-item"><?php echo '<a href="#tab5" role="tab" data-toggle="tab" class="nav-link">' . $CLICSHOPPING_Products->getDef('tab_img'); ?></a></li>
        <li class="nav-item"><?php echo '<a href="#tab6" role="tab" data-toggle="tab" class="nav-link">' . $CLICSHOPPING_Products->getDef('tab_ref'); ?></a></li>
        <li class="nav-item"><?php echo '<a href="#tab9" role="tab" data-toggle="tab" class="nav-link">' . $CLICSHOPPING_Products->getDef('tab_other_options'); ?></a></li>
      </ul>
...
?>
        <div class="form-group row">
          ...
          <div class="col-md-5"><?php echo  HTML::inputField('products_name[' . $languages[$i]['id'] . ']', (isset($products_name[$languages[$i]['id']]) ? $products_name[$languages[$i]['id']] : $CLICSHOPPING_ProductsAdmin->getProductsName($pInfo->products_id, $languages[$i]['id'])), 'required aria-required="true" id="products_name" placeholder="' . $CLICSHOPPING_Products->getDef('text_products_name') . '"',  true) . '&nbsp;'; ?></div>
        </div>
<?php
  }
?>
      ...
      <div class="adminformTitle">
          ...
          <div class="col-md-5" id="tab1ContentRow3Model">
            <div class="form-group row">
              ...
              <div class="col-md-5">
                ...
                <a href="<?php echo $CLICSHOPPING_Products->link('ConfigurationPopUpFields&cKey=CONFIGURATION_PREFIX_MODEL'); ?>"  data-toggle="modal" data-refresh="true" data-target="#myModal"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . 'icons/edit.gif', $CLICSHOPPING_Products->getDef('text_edit')); ?></a>
        ...
        <div class="row" id="tab1ContentRow10">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-5">
                <label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                  <span class="col-md-1"><?php echo HTML::checkboxField('products_only_shop', '1', $pInfo->products_only_shop); ?></span>
                </label>
              </div>
            </div>
          </div>
          <div class="col-md-5">
            <div class="form-group row">
              <label for="<?php echo $CLICSHOPPING_Products->getDef('text_products_only_online'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Products->getDef('text_products_only_online'); ?></label>
              <div class="col-md-5">
                <label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                  <span class="col-md-1"><?php echo HTML::checkboxField('products_only_online', '1', $pInfo->products_only_online); ?></span>
                </label>
              </div>
            </div>
          </div>
...
?>
        <div class="form-group row">
          <label for="code" class="col-2 col-form-label"><?php echo $CLICSHOPPING_Language->getImage($languages[$i]['code']); ?></label>
          <div class="col-md-5"><?php echo HTML::inputField('products_shipping_delay[' . $languages[$i]['id'] . ']', (isset($products_shipping_delay[$languages[$i]['id']]) ? $products_shipping_delay[$languages[$i]['id']] : $CLICSHOPPING_ProductsAdmin->getProductsShippingDelay($pInfo->products_id, $languages[$i]['id'])), 'size="90"'); ?></div>
        </div>
<?php
  }
?>
    ...
    <div class="tab-pane" id="tab2">
      ...
      <div class="adminformTitle">
        ...
        <div class="row" id="tab2ContentRow21">
          <div class="col-md-5">
            <div class="form-group row">
              <label for="<?php echo $CLICSHOPPING_Products->getDef('text_products_stock'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Products->getDef('text_products_stock'); ?></label>
              <div class="col-md-5">
          ...
          <div class="col-md-5" id="tab2ContentRow3">
            <div class="form-group row">
              <label for="<?php echo $CLICSHOPPING_Products->getDef('text_products_alert'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Products->getDef('text_products_alert'); ?></label>
              <div class="col-md-5">
                <?php echo HTML::inputField('products_quantity_alert', $pInfo->products_quantity_alert, 'id="products_quantity_alert"'); ?>
                <a href="<?php echo $CLICSHOPPING_Products->link('ConfigurationPopUpFields&cKey=STOCK_REORDER_LEVEL'); ?>"  data-toggle="modal" data-refresh="true" data-target="#myModal2"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . 'icons/edit.gif', $CLICSHOPPING_Products->getDef('text_edit_default_configuration')); ?></a>
        ...
        <div class="row" id="tab2ContentRow5">
          ...
          <div class="col-md-5">
            <div class="form-group row">
              <label for="<?php echo $CLICSHOPPING_Products->getDef('text_products_min_order_quantity'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Products->getDef('text_products_min_order_quantity'); ?></label>
              <div class="col-md-5">
<?php
...
?>
                <a href="<?php echo $CLICSHOPPING_Products->link('ConfigurationPopUpFields&cKey=MAX_MIN_IN_CART'); ?>"  data-toggle="modal" data-refresh="true" data-target="#myModal2"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . 'icons/edit.gif', $CLICSHOPPING_Products->getDef('text_edit_default_configuration')); ?></a>
                <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-body"><div class="te"></div></div>
        ...
        <div class="row" id="tab2ContentRow6">
          <div class="col-md-5">
            <div class="form-group row">
              <label for="<?php echo $CLICSHOPPING_Products->getDef('text_products_type'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Products->getDef('text_products_type'); ?></label>
              <div class="col-md-5">
      ...
      <div class="adminformTitle"  style="padding-top: 0rem; padding-left: 0rem; padding-bottom: 0rem;">
        <div style="background-color:#ebebff; height:100%;">
          ...
          <div class="row" id="tab3ContentRow1">
            <div class="col-md-5">
              <div class="form-group row">
                <label for="<?php echo $CLICSHOPPING_Products->getDef('text_products_tax_class'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Products->getDef('text_products_tax_class'); ?></label>
                <div class="col-md-5">
          ...
          <div class="row" id="tab3ContentRow2">
            <div class="col-md-5">
              <div class="form-group row">
                <label for="<?php echo $CLICSHOPPING_Products->getDef('text_products_price'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Products->getDef('text_products_price'); ?></label>
                <div class="col-md-5">
<?php
...
?>
          ...
          <div class="row" id="tab3ContentRow3">
            <div class="col-md-5">
              <div class="form-group row">
                <label for="<?php echo $CLICSHOPPING_Products->getDef('text_products_cost'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Products->getDef('text_products_cost'); ?></label>
                <div class="col-md-5">
          ...
          <div class="row" id="tab3ContentRow4">
            <div class="col-md-5">
              <div class="form-group row">
                <label for="<?php echo $CLICSHOPPING_Products->getDef('text_products_handling'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Products->getDef('text_products_handling'); ?></label>
                <div class="col-md-5">
          ...
          <div class="row" id="tab3ContentRow5">
            <div class="col-md-5">
              <div class="form-group row">
                <label for="<?php echo $CLICSHOPPING_Products->getDef('text_products_price_margins'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Products->getDef('text_products_price_margins'); ?></label>
                <div class="col-md-5">
          ...
          <div class="row" id="tab3ContentRow6">
            <div class="col-md-5">
              <div class="form-group row">
                <label for="<?php echo $CLICSHOPPING_Products->getDef('products_view'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Products->getDef('products_view'); ?></label>
                <div class="col-md-5">
<?php
  if (isset($_GET['pID'])) {
?>
...
?>
          ...
          <div class="row" id="tab3ContentRow7">
            <div class="col-md-5">
              <div class="form-group row">
                <label for="<?php echo $CLICSHOPPING_Products->getDef('text_products_price_kilo'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Products->getDef('text_products_price_kilo'); ?></label>
                <div class="col-md-5">
...
?>
        <div class="row" id="tab4ContentRow1">
          <span class="col-sm-2"><?php echo $CLICSHOPPING_Language->getImage($languages[$i]['code']); ?>&nbsp;</span>
          <span class="col-sm-10">
            <div style="visibility:visible; display:block;"><?php echo HTMLOverrideAdmin::textAreaCkeditor('products_description[' . $languages[$i]['id'] . ']', 'soft', '750', '300', (isset($products_description[$languages[$i]['id']]) ? str_replace('& ', '&amp; ', trim($products_description[$languages[$i]['id']])) : $CLICSHOPPING_ProductsAdmin->getProductsDescription($pInfo->products_id, $languages[$i]['id']))); ?></div>
          </span>
        </div>
        <div class="separator"></div>
        <div id="tab4ContentRow2">
          <span class="col-sm-12"><?php echo $CLICSHOPPING_Products->getDef('text_products_description_summary'); ?></span>
        </div>
      ...
      <div class="alert alert-info" role="alert">
        ...
        <div class="row">
          <span class="col-sm-12">
            ...
            <blockquote><i><a data-toggle="modal" data-target="#myModalWysiwyg"><?php echo $CLICSHOPPING_Products->getDef('text_help_wysiwyg'); ?></a></i></blockquote>
            <div class="modal fade" id="myModalWysiwyg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel"><?php echo $CLICSHOPPING_Products->getDef('text_help_wysiwyg'); ?></h4>
                  </div>
      ...
      <div class="adminformTitle">
        <div class="row" id="tab5ContentRow1">
          <div class="col-md-6 float-md-left">
            ...
            <div class="separator"></div>
            <div class="col-md-12">
              <span class="col-sm-6"><?php echo $CLICSHOPPING_Products->getDef('text_products_image_directory'); ?></span>
              <span class="col-sm-6"><?php  echo HTML::selectMenu('directory_products_image', $CLICSHOPPING_ProductsAdmin->getDirectoryProducts()); ?><span>
            </div>
            <div class="col-md-12">
          ...
          <div class="col-md-5 float-md-right">
            <div class="col-md-12">
              <span class="col-sm-1"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . '/images_product_images.gif', $CLICSHOPPING_Products->getDef('text_products_image_visuel'), '40', '40'); ?></span>
      ...
      <div class="adminformTitle">
        ...
        <div class="row" id="tab6ContentRow1">
          <div class="col-md-12">
            ...
            <span class="col-sm-3"><a href="https://www.google.fr/trends" target="_blank"><?php echo $CLICSHOPPING_Products->getDef('keywords_google_trend'); ?></a></span>
            <span class="col-sm-3"><a href="https://adwords.google.com/select/KeywordToolExternal" target="_blank"><?php echo $CLICSHOPPING_Products->getDef('analysis_google_tool'); ?></a></span>
          </div>
        </div>
<?php
  for ($i=0, $n=count($languages); $i<$n; $i++) {
    ...
    <div class="tab-pane" id="tab9">
      ...
      <div class="adminformTitle" id="tab9Content">
        ...
        <div class="row" id="tab9ContentRow1">
          <div class="col-md-9">
            <div class="form-group row">
              <label for="<?php echo $CLICSHOPPING_Products->getDef('text_products_file_download_public'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Products->getDef('text_products_file_download_public'); ?></label>
              <div class="col-md-5">
        ...
        <div class="row" id="tab9ContentRow2">
          <div class="col-md-9">
            <div class="form-group row">
              <label for="<?php echo $CLICSHOPPING_Products->getDef('text_products_file_download'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Products->getDef('text_products_file_download'); ?></label>
              <div class="col-md-5">
<?php
