...
?>
  <div class="contentBody">
    ...
    <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_Products->getDef('text_info_heading_archive'); ?></strong></div>
    ...
    <div class="adminformTitle">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <span class="col-sm-4"><?php echo '<strong>' . $CLICSHOPPING_CategoriesAdmin->getOutputGeneratedCategoryPath($pInfo->products_id, 'product') . '</strong>'; ?></span>
        </div>
        <div class="separator"></div>
