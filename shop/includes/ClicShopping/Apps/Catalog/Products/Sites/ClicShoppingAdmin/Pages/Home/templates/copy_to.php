    ...
    <div class="adminformTitle">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <span class="col-sm-4"><br /><?php echo  HTML::selectMenu('categories_id[]', $CLICSHOPPING_CategoriesAdmin->getCategoryTree(), $current_category_id, 'multiple="multiple" size="10"'); ?></span>
        </div>
        <div class="col-md-12">
          <span class="col-sm-2"><?php echo $CLICSHOPPING_Products->getDef('text_how_to_copy'); ?></span>
          <span class="col-sm-4"><br /><?php echo HTML::radioField('copy_as', 'link', true) . ' ' . $CLICSHOPPING_Products->getDef('text_copy_as_link'); ?></span>
          <span class="col-sm-4"><br /><?php echo HTML::radioField('copy_as', 'duplicate') . ' ' . $CLICSHOPPING_Products->getDef('text_copy_as_duplicate'); ?></span>
        </div>
        <div class="separator"></div>
