    ...
    */
    ...
    public function setProductsAllowingToInsertQuantity($id = null)
    {
      ...
      if ($this->customer->getCustomersGroupID() != 0 && $this->getOrdersGroupView() != 0) {
        ...
        $input_quantity .= HTML::inputField('cart_quantity', (int)$this->setProductsMinimumQuantityToTakeAnOrder($id), 'id="Quantity' . $id . '" class="input-small" maxlength="4" size="4" min="0"') . '&nbsp;&nbsp;';
      } else {
        $input_quantity = '';
      }
