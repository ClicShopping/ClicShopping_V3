    ...
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span
            class="col-md-3 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_StatsProductsPurchased->getDef('heading_title'); ?></span>
        </div>
      </div>
    </div>
  </div>
    ...
    <td>
      <table class="table table-sm table-hover table-striped">
        ...
        <tr class="dataTableHeadingRow">
          ...
          <th
            class="text-md-center"><?php echo $CLICSHOPPING_StatsProductsPurchased->getDef('table_heading_purchased'); ?>
            &nbsp;
          </th>
          <th class="text-md-right"><?php echo $CLICSHOPPING_StatsProductsPurchased->getDef('table_heading_clear'); ?>
            &nbsp;
          </th>
        </tr>
        </thead>
        ...
        <?php
          ...
          if ($listingTotalRow > 0) {
            while ($products = $Qproducts->fetch()) {
              ...
              <tr>
                <td scope="row"
                    width="50px"><?php echo HTML::link(CLICSHOPPING::link(null, 'A&Catalog\Preview&Preview&pID=' . $Qproducts->valueInt('products_id') . '?page=' . $page), HTML::image($CLICSHOPPING_Template->getImageDirectory() . 'icons/preview.gif', $CLICSHOPPING_StatsProductsPurchased->getDef('text_preview'))); ?></td>
  ...
  <?php
    if ($listingTotalRow > 0) {
      ...
      <div class="row">
        <div class="col-md-12">
          <div
            class="col-md-6 float-md-left pagenumber hidden-xs TextDisplayNumberOfLink"><?php echo $Qproducts->getPageSetLabel($CLICSHOPPING_StatsProductsPurchased->getDef('text_display_number_of_link')); ?></div>
          <div
