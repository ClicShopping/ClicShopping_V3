...
<div class="contentBody">
  ...
  <div class="col-md-12 mainTitle">
    <strong><?php echo $CLICSHOPPING_StatsProductsExpected->getDef('text_stats_products_expected'); ?></strong></div>
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-12 text-md-center">
          <div class="form-group">
            <div class="col-md-12">
              <?php
                echo HTML::form('configure', CLICSHOPPING::link(null, 'A&Report\StatsProductsExpected&Configure'));
