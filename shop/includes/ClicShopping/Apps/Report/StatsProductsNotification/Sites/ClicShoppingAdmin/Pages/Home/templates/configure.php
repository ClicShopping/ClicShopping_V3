 ...
 */
  ...
  if ($CLICSHOPPING_MessageStack->exists('StatsProductsNotification')) {
    echo $CLICSHOPPING_MessageStack->get('StatsProductsNotification');
  }
?>
...
<?php
  if ($CLICSHOPPING_StatsProductsNotification_Config->is_installed === true) {
?>
  <form name="CustomersCustomersConfigure" action="<?php echo $CLICSHOPPING_StatsProductsNotification->link('Configure&Process&module=' . $current_module); ?>" method="post">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><?php echo $CLICSHOPPING_StatsProductsNotification->getDef('dialog_uninstall_title'); ?></h4>
            </div>
...
?>
   <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_StatsProductsNotification->getConfigModuleInfo($current_module, 'title'); ?></strong></div>
      <div class="adminformTitle">
        <div class="row">
          <div class="separator"></div>
          <div class="col-md-12">
