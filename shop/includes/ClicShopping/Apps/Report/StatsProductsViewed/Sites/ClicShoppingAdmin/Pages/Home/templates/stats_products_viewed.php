    ...
    <td>
      <table class="table table-sm table-hover table-striped">
        ...
        <tr class="dataTableHeadingRow">
          ...
          <th class="text-md-center"><?php echo $CLICSHOPPING_StatsProductsViewed->getDef('table_heading_viewed'); ?>
            &nbsp;
          </th>
          <th class="text-md-right"><?php echo $CLICSHOPPING_StatsProductsViewed->getDef('table_heading_clear'); ?>
            &nbsp;
          </th>
        </tr>
        </thead>
          ...
          if ($listingTotalRow > 0) {
            ...
            while ($products = $Qproducts->fetch()) {
              ...
              <tr>
                ...
                <td
                  class="text-md-right"><?php echo HTML::link($CLICSHOPPING_StatsProductsViewed->link('StatsProductsViewed&Update&resetViewed=1&products_id=' . $Qproducts->valueInt('products_id') . '&page=' . $page), HTML::image($CLICSHOPPING_Template->getImageDirectory() . 'icons/delete.gif', $CLICSHOPPING_StatsProductsViewed->getDef('image_delete'))); ?></td>
                </form>
              </tr>
              <?php
            }
  ...
  <?php
    if ($listingTotalRow > 0) {
      ...
      <div class="row">
        <div class="col-md-12">
          <div
            class="col-md-6 float-md-left pagenumber hidden-xs TextDisplayNumberOfLink"><?php echo $Qproducts->getPageSetLabel($CLICSHOPPING_StatsProductsViewed->getDef('text_display_number_of_link')); ?></div>
          <div
