<?php
  ...
  class Install extends \ClicShopping\OM\PagesActionsAbstract
  {
    ...
    public function execute()
    {
      ...
      $CLICSHOPPING_StatsProductsViewed->loadDefinitions('Sites/ClicShoppingAdmin/install');
      ...
      $CLICSHOPPING_MessageStack->add($CLICSHOPPING_StatsProductsViewed->getDef('alert_module_install_success'), 'success', 'StatsProductsViewed');
    ...
    private static function installDbMenuAdministration()
    {
      ...
      if ($Qcheck->fetch() === false) {
        ...
        $sql_data_array = ['sort_order' => 5,
          'link' => 'index.php?A&Report\StatsProductsViewed&StatsProductsViewed',
        ...
        for ($i = 0, $n = count($languages); $i < $n; $i++) {
          ...
          $sql_data_array = ['label' => $CLICSHOPPING_StatsProductsViewed->getDef('title_menu')];
