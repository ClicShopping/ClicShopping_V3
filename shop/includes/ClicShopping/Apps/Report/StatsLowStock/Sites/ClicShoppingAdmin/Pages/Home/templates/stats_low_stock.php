    ...
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span
            class="col-md-2 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_StatsLowStock->getDef('heading_title'); ?></span>
        </div>
      </div>
    </div>
  </div>
    ...
    <td>
      <table class="table table-sm table-hover table-striped">
        ...
        <tr class="dataTableHeadingRow">
          ...
          <th
            class="text-md-center"><?php echo $CLICSHOPPING_StatsLowStock->getDef('table_heading_wahrehouse_time_replenishment'); ?></th>
          <th class="text-md-center"><?php echo $CLICSHOPPING_StatsLowStock->getDef('table_heading_warehouse'); ?></th>
          <th
            class="text-md-center"><?php echo $CLICSHOPPING_StatsLowStock->getDef('table_heading_warehouse_row'); ?></th>
          <th
            class="text-md-center"><?php echo $CLICSHOPPING_StatsLowStock->getDef('table_heading_warehouse_level'); ?></th>
        ...
        <?php
          ...
          if ($listingTotalRow > 0) {
            ...
            while ($Qproducts->fetch()) {
              ...
              <tr>
                <td scope="row"
                    width="50px"><?php echo HTML::link(CLICSHOPPING::link(null, 'A&Catalog\Preview&Preview&pID=' . $Qproducts->valueInt('products_id') . '?page=' . $page), HTML::image($CLICSHOPPING_Template->getImageDirectory() . 'icons/preview.gif', $CLICSHOPPING_StatsLowStock->getDef('icon_preview'))); ?></td>
                ...
                <td
                  class="text-md-right"><?php echo HTML::link(CLICSHOPPING::link(null, 'A&Catalog\Products&Products&action=new_product&pID=' . $Qproducts->valueInt('products_id')), HTML::image($CLICSHOPPING_Template->getImageDirectory() . 'icons/edit.gif', $CLICSHOPPING_StatsLowStock->getDef('icon_edit'))); ?></td>
              </tr>
              <?php
            }
          } // end $listingTotalRow
  ...
  <?php
    if ($listingTotalRow > 0) {
      ...
      <div class="row">
        <div class="col-md-12">
          <div
            class="col-md-6 float-md-left pagenumber hidden-xs TextDisplayNumberOfLink"><?php echo $Qproducts->getPageSetLabel($CLICSHOPPING_StatsLowStock->getDef('text_display_number_of_link')); ?></div>
          <div
