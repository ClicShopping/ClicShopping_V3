  ...
  <div class="adminformTitle">
    <div class="row">
      ...
      <div class="col-md-12 text-md-center">
        <span><br/><?php echo HTML::button($CLICSHOPPING_TaxRates->getDef('button_delete'), null, null, 'danger', null, 'sm') . ' </span><span>' . HTML::button($CLICSHOPPING_TaxRates->getDef('button_cancel'), null, $CLICSHOPPING_TaxRates->link('TaxRates&page=' . HTML::sanitize($_GET['page']) . '&tID=' . $trInfo->tax_rates_id), 'warning', null, 'sm'); ?></span>
      </div>
    </div>
  </div>
  </form>
