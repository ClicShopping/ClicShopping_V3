...
<div class="contentBody">
    ...
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span class="col-md-2 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_Administrators->getDef('heading_title'); ?></span>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="adminformTitle">
    <div class="row">
      <div class="separator"></div>
      <div class="col-md-12"><?php echo $CLICSHOPPING_Administrators->getDef('text_info_delete_intro'); ?><br /><br /></div>
      <div class="separator"></div>
      <div class="col-md-12">
      ...
      <div class="col-md-12 text-md-center">
        <span class="text-md-center"><?php echo HTML::button($CLICSHOPPING_Administrators->getDef('button_delete'), null, null, 'danger', null, 'sm') . ' </span><span>' . HTML::button($CLICSHOPPING_Administrators->getDef('button_cancel'), null, $CLICSHOPPING_Administrators->link('Administrators&aID=' . $Qadmin->valueInt('id')), 'warning', null, 'sm'); ?></span>
      </div>
    </div>
  </div>
</div>