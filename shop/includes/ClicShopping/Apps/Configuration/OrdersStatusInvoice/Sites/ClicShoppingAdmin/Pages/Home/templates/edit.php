...
<?php
  echo HTML::form('status_orders_status_invoice', $CLICSHOPPING_OrdersStatusInvoice->link('OrdersStatusInvoice&Update&page=' . HTML::sanitize($_GET['page']) . '&oID=' . $oInfo->orders_status_invoice_id));
