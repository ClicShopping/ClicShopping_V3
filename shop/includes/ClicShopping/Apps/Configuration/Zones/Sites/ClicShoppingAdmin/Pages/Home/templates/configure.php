      ...
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span class="col-md-7 text-md-right">
            ...
            <?php echo HTML::button($CLICSHOPPING_Zones->getDef('button_back'), null, $CLICSHOPPING_Zones->link('index.php', 'A&Configuration\Zones'), 'primary'); ?>
        </div>
      </div>
    </div>
  </div>
...
?>
  <form name="ConfigurationZonesConfigure" action="<?php echo $CLICSHOPPING_Zones->link('Configure&Process&module=' . $current_module); ?>" method="post">
...
?>
     <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_Zones->getConfigModuleInfo($current_module, 'title'); ?></strong></div>
     <div class="adminformTitle">
       <div class="row">
         <div class="separator"></div>
          <div class="col-md-12">
