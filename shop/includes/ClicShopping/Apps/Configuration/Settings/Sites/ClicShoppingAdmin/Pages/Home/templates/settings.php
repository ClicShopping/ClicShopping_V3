  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          <span class="col-md-1 logoHeading"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . '/categories/configuration_' . $gID . '.gif', $CLICSHOPPING_Settings->getDef('heading_title'), '40', '40'); ?></span>
          <span class="col-md-11 pageHeading"><?php echo '&nbsp;' . $QcfgGroup->value('configuration_group_title'); ?></span>
        </div>
      </div>
    </div>
  </div>
    ...
    $( document ).ready(function() {
      $("#myModal_<?php echo $Qconfiguration->valueInt('configuration_id'); ?>").on("show.bs.modal", function(e) {
        ...
        $(this).find(".modal-body").load(link.attr("href"));
            ...
            <a href="<?php echo $CLICSHOPPING_Settings->link('SettingsPopUp&Save&gID=' . $_GET['gID'] . '&cID=' . $Qconfiguration->valueInt('configuration_id')); ?>"  data-toggle="modal" data-refresh="true" data-target="#myModal_<?php echo $Qconfiguration->valueInt('configuration_id'); ?>"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . 'icons/edit.gif', $CLICSHOPPING_Settings->getDef('icon_edit')); ?></a>
