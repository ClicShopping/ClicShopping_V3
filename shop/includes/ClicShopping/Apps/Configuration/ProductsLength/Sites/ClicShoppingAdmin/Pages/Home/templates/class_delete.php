...
<div class="contentBody">
    ...
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span class="col-md-2 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_ProductsLength->getDef('heading_title'); ?></span>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="adminformTitle">
    <div class="row">
      <div class="separator"></div>
      <div class="col-md-12"><?php echo $CLICSHOPPING_ProductsLength->getDef('text_info_delete_info'); ?><br/><br/></div>
      <div class="separator"></div>
      <div class="col-md-12"><?php echo '<strong>' . $CLICSHOPPING_ProductsLength->getDef('text_products_length_rules') . ' ' . $wInfo->products_length_class_rule . '</strong>'; ?><br/><br/></div>
      <div class="col-md-12 text-md-center">
        <span><br /><?php echo HTML::button($CLICSHOPPING_ProductsLength->getDef('button_delete'), null, null, 'danger', null, 'sm') . ' </span><span>' . HTML::button($CLICSHOPPING_ProductsLength->getDef('button_cancel'), null, $CLICSHOPPING_ProductsLength->link('ProductsLength&page=' . $_GET['page'] . '&tID=' . $wInfo->products_length_id), 'warning', null, 'sm'); ?></span>
      </div>
    </div>
  </div>
