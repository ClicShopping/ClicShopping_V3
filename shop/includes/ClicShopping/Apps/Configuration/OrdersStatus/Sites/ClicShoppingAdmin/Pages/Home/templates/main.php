...
?>
  <div class="contentBody">
    ...
    <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_OrdersStatus->getDef('text_orders_status') ; ?></strong></div>
...
<?php
  echo HTML::form('configure', CLICSHOPPING::link('index.php', 'A&Configuration\OrdersStatus&Configure'));
