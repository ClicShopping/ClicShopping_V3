    ...
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span class="col-md-7 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_Langues->getDef('heading_title'); ?></span>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-group row">
          <label for="<?php echo $CLICSHOPPING_Langues->getDef('text_info_edit_intro'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Langues->getDef('text_info_edit_intro'); ?></label>
        </div>
      </div>
    </div>
...
?>
          <div class="col-md-12">
            ...
            <span class="col-md-4"><br /><?php echo  HTML::checkboxField('default') . ' ' . $CLICSHOPPING_Langues->getDef('text_set_default'); ?></span>
          </div>
<?php
  }
?>
