...
//date_sub(curdate(), interval 360 day)
      ...
      $chart_label = HTML::output($this->app->getDef('module_admin_dashboard_total_month_app_chart_link'));
      ...
      $content_width = 'col-lg-' . (int)MODULE_ADMIN_DASHBOARD_TOTAL_MONTH_APP_CONTENT_WIDTH;

      $output = <<<EOD
<span class="$content_width text-md-center">
<div class="text-md-center">$chart_title</div>
<div id="d_total_month" class="col-md-12" style="width:100%; height: 200px;"></div>
