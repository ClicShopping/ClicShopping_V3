    ...
    <div class="footerTemplateBox footerTemplateInformation">
      ...
      <ul class="footerTemplateSocial">
        <span itemscope itemtype="https://schema.org/Organization">
          ...
          <li><a itemprop="sameAs" href="<?php echo $facebook_url;?>" target="_blank" rel="noreferrer"><i class="fab fa-facebook-f"></i></a></li>
          <li><a itemprop="sameAs" href="<?php echo $twitter_url;?>" target="_blank" rel="noreferrer"><i class="fab fa-twitter"></i></a></li>
          <li><a itemprop="sameAs" href="<?php echo $googleplus_url;?>" target="_blank" rel="noreferrer"><i class="fab fa-google-plus"></i> </a> </li>
          <li><a itemprop="sameAs" href="<?php echo $pinterest_url;?>" target="_blank" rel="noreferrer"><i class="fab fa-pinterest"></i></a></li>
        </span>
      </ul>
    </div>
