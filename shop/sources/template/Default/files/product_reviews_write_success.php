...
?>
<script type="text/javascript" src="<?php echo $CLICSHOPPING_Template->getTemplateDefaultJavaScript('clicshopping/review_write.js.php'); ?>"></script>

<?php require($CLICSHOPPING_Template->getTemplateFiles('breadcrumb')); ?>
