...
if (PHP_VERSION < 7.3) {
    $warning_array[] = 'The minimum required PHP version is v7.3 (7.2 must work but the optimization is made for 7.3) - please ask your host or server administrator to upgrade the PHP version to continue installation.';
}
