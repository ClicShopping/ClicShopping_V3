...
INSERT INTO `clic_configuration` VALUES(700, 'Do you want display State / Department dropown ?', 'ACCOUNT_STATE_DROPDOWN', 'false', 'Display departments or states when you select a country<br>', 5, 5, NULL, '2018-07-29 16:22:38', NULL, 'clic_cfg_set_boolean_value(array(\'true\', \'false\'))');
...
INSERT INTO `clic_configuration` VALUES(931, 'Who is authorized to access at the catalog where the sore is offline ?', 'STORE_OFFLINE_ALLOW', '', 'Please insert the ip address like this 127.0.0.1, 194.25.0.50, 158.125.124.23', 1, 24, NULL, '2018-07-30 14:25:01', NULL, '');
