...
INSERT INTO `clic_configuration` VALUES(1094, 'Please indicate where you want to display the module ?', 'MODULE_PRODUCTS_INFO_MODEL_POSITION', 'float-md-none', 'Indicate where you want to display the module', 6, 2, NULL, '2018-07-31 11:13:00', NULL, 'clic_cfg_set_boolean_value(array(\'float-md-right\', \'float-md-left\', \'float-md-none\') ');
...
INSERT INTO `clic_configuration` VALUES(1098, 'Please indicate where you want to display the module ?', 'MODULE_PRODUCTS_INFO_NAME_POSITION', 'float-md-none', 'Indicate where you want to display the module', 6, 2, NULL, '2018-07-31 11:13:05', NULL, 'clic_cfg_set_boolean_value(array(\'float-md-right\', \'float-md-left\', \'float-md-none\') ');
...
INSERT INTO `clic_configuration` VALUES(1112, 'Please indicate where you want to display the module ?', 'MODULE_LOGIN_CONNEXION_POSITION', 'float-md-none', 'Affiche le module à gauche ou à droite<br><br><i>(Valeur Left = Gauche <br>Valeur Right = Droite <br>Valeur None = Aucun)</i>', 6, 2, NULL, '2018-07-31 14:31:44', NULL, 'clic_cfg_set_boolean_value(array(\'float-md-right\', \'float-md-left\', \'float-md-none\'),');
...
INSERT INTO `clic_configuration` VALUES(1116, 'Please indicate where you want to display the module ?', 'MODULE_LOGIN_MODE_B2B_POSITION', 'float-md-none', 'Affiche le module à gauche ou à droite<br><br><i>(Valeur Left = Gauche <br>Valeur Right = Droite <br>Valeur None = Aucun)</i>', 6, 2, NULL, '2018-07-31 14:31:48', NULL, 'clic_cfg_set_boolean_value(array(\'float-md-right\', \'float-md-left\', \'float-md-none\'),');
...
INSERT INTO `clic_configuration` VALUES(1123, 'Please indicate where you want to display the module ?', 'MODULE_LOGIN_MODE_B2C_POSITION', 'float-md-none', 'Affiche le module à gauche ou à droite<br><br><i>(Valeur Left = Gauche <br>Valeur Right = Droite <br>Valeur None = Aucun)</i>', 6, 2, NULL, '2018-07-31 14:31:56', NULL, 'clic_cfg_set_boolean_value(array(\'float-md-right\', \'float-md-left\', \'float-md-none\'),');
...
INSERT INTO `clic_configuration` VALUES(1380, 'Where do you want display the module ?', 'MODULE_LOGIN_MODE_B2B_B2C_POSITION', 'float-md-none', 'Select where you want display the module', 6, 2, NULL, '2018-10-02 22:28:26', NULL, 'clic_cfg_set_boolean_value(array(\'float-right\', \'float-left\', \'float-md-none\'))');
