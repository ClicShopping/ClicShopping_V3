...
INSERT INTO `clic_configuration` VALUES(687, 'What type of container should the page content (full-size or centered)', 'BOOTSTRAP_CONTAINER', 'container-fluid', 'Please, select your preference (More information on : https://getbootstrap.com/docs/4.4/examples/grid/#containers)', 43, 1, '2016-10-11 17:07:12', '2015-02-19 21:39:51', NULL, 'clic_cfg_set_boolean_value(array(\'container\', \'container-fluid\', \'container-sm\', \'container-md\', \'container-lg\', \'.container-xl\'))');
...
--
ALTER TABLE `clic_configuration`
  MODIFY `configuration_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1542;
