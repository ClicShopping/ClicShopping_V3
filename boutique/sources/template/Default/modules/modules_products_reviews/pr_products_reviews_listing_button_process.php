...
class pr_products_reviews_listing_button_process {
  ...
  public function __construct() {
    ...
    if ( defined('MODULES_PRODUCTS_REVIEWS_LISTING_BUTTON_PROCESS_STATUS') ) {
      ...
      $this->enabled = MODULES_PRODUCTS_REVIEWS_LISTING_BUTTON_PROCESS_STATUS;
    }
  }
  ...
  public function execute() {
    ...
    if (isset($_GET['Products']) && isset($_GET['Review'])) {
      ...
      ob_start();
      require($CLICSHOPPING_Template->getTemplateModules($this->group . '/content/products_reviews_listing_button_process'));
