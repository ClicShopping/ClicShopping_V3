  ...
  class pr_products_reviews_write_customer_agreement {
    ...
    public function __construct() {
      ...
      if ( defined('MODULES_PRODUCTS_REVIEWS_WRITE_CUSTOMER_AGREEMENT_STATUS') ) {
        ...
        $this->enabled = MODULES_PRODUCTS_REVIEWS_WRITE_CUSTOMER_AGREEMENT_STATUS;
      }
    }
    ...
    public function execute() {
      ...
      if (isset($_GET['Products']) && isset($_GET['ReviewsWrite']) && !isset($_GET['Success'])) {
        ...
        if (DISPLAY_PRIVACY_CONDITIONS == 'true') {
          $customer_agree_privacy =  HTML::checkboxField('customer_agree_privacy', null, 'required aria-required="true"') . ' ' . CLICSHOPPING::getDef('text_privacy_conditions_agree');
