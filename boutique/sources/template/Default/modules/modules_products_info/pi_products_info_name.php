  ...
  class pi_products_info_name {
    ...
    public function __construct() {
      ...
      if (defined('MODULE_PRODUCTS_INFO_NAME_STATUS')) {
        $this->sort_order = MODULE_PRODUCTS_INFO_NAME_SORT_ORDER;
        $this->enabled = MODULE_PRODUCTS_INFO_NAME_STATUS;
      }
    }
    ...
    public function execute() {
      ...
      if (isset($_GET['products_id']) && isset($_GET['Products']) ) {
        ...
        ob_start();
        require($CLICSHOPPING_Template->getTemplateModules($this->group . '/content/products_info_name'));
        $products_name_content .= ob_get_clean();

        $products_name_content .= '<!-- end products_name -->' . "\n";
