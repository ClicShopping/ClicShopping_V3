  ...
  class ac_account_customers_history_info_address {
    ...
    public function __construct() {
      ...
      if (defined('MODULE_ACCOUNT_CUSTOMERS_HISTORY_INFO_ADDRESS_TITLE_STATUS')) {
        ...
        $this->enabled = MODULE_ACCOUNT_CUSTOMERS_HISTORY_INFO_ADDRESS_TITLE_STATUS;
      }
    }
    ...
    public function execute() {
      ...
      if (isset($_GET['Account']) &&  isset($_GET['HistoryInfo']) ) {
        ...
        ob_start();
        require($CLICSHOPPING_Template->getTemplateModules($this->group . '/content/account_customers_history_info_address'));
