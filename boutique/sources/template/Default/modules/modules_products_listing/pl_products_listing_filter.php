  ...
  class pl_products_listing_filter  {
    ...
    public function __construct()  {
      ...
      if (defined('MODULE_PRODUCTS_LISTING_FILTER_STATUS')) {
        ...
        $this->enabled = MODULE_PRODUCTS_LISTING_FILTER_STATUS;
      }
    }
...
// Affichage du menu deroulant des Marques sur la liste des produits d'une categorie
            ...
            //    $products_listing_filter .= HTML::form('filter', CLICSHOPPING::link('index.php'), 'get');

                $products_listing_filter .=  HTML::form('filter', CLICSHOPPING::link('index.php', '', false), 'get', null, ['session_id' => true]);
