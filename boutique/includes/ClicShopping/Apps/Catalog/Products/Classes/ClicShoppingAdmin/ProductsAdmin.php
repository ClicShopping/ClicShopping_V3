    ...
    private function saveFileUpload() {
      if (!is_null($_POST['products_download_filename'])) {
        ...
        if ($upload_file->check()) {
          $file = $this->removeFileAccents($_POST['products_download_filename']);
 ...
 * osc_remove_file_accents
 */

    private function removeFileAccents($character) {
...
// image resample
        $new_dir_products_image_without_accents = $this->removeFileAccents($_POST['new_directory_products_image']);
...
// Zoom image
          ...
          $big_image_resized = $dir_products_image . $big_image_width . '_' . $image_name;
...
// medium image
          ...
          $medium_image_resized = $dir_products_image . $medium_image_width . '_' . $image_name;
...
// small image
          ...
          $small_image_resized = $dir_products_image . $small_image_width . '_' . $image_name;
...
// gallery
      $new_dir_without_accents = $this->removeFileAccents($_POST['new_directory']);
