...
?>
  <form name="ConfigurationTaxGeoZonesConfigure" action="<?php echo $CLICSHOPPING_TaxGeoZones->link('Configure&Process&module=' . $current_module); ?>" method="post">
...
?>
     <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_TaxGeoZones->getConfigModuleInfo($current_module, 'title'); ?></strong></div>
     <div class="adminformTitle">
       <div class="row">
         <div class="separator"></div>
          <div class="col-md-12">
