...
?>
  <div class="contentBody">
    ...
    <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_OrdersStatusInvoice->getDef('text_orders_status_invoice') ; ?></strong></div>
...
<?php
  echo HTML::form('configure', CLICSHOPPING::link('index.php', 'A&Configuration\OrdersStatusInvoice&Configure'));
