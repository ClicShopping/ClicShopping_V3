...
?>
              <tr>
                <th scope="row" width="50"><?php echo HTML::link(CLICSHOPPING::link('index.php', 'A&Catalog\Preview&Preview&pID=' . $Qproducts->valueInt('products_id') . '&origin=' . 'stats_products_viewed.php' . '?page=' . $_GET['page']), HTML::image($CLICSHOPPING_Template->getImageDirectory() . 'icons/preview.gif', $CLICSHOPPING_StatsProductsPurchased->getDef('text_prview'))); ?></th>
                ...
                <td><?php echo $rows; ?>.</td>
                <td><?php echo HTML::link(CLICSHOPPING::link('index.php', 'A&Catalog\Preview&Preview&pID=' . $Qproducts->valueInt('products_id') . '&origin=' . 'stats_products_purchased.php' . '?page=' . $_GET['page']), $Qproducts->value('products_name')); ?></td>
