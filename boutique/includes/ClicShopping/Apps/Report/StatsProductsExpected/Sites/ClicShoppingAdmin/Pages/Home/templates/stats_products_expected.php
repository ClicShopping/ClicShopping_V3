      ...
      <td>
        <table class="table table-sm table-hover table-striped">
          ...
          <tr class="dataTableHeadingRow">
            ...
            <th class="text-md-center"><?php echo $CLICSHOPPING_StatsProductsExpected->getDef('table_heading_date_expected'); ?></th>
            <th class="text-md-right"><?php echo $CLICSHOPPING_StatsProductsExpected->getDef('table_heading_action'); ?>&nbsp;</th>
          </tr>
          </thead>
          <tbody>
<?php
...
?>
                <tr>
                  <td class="dataTableContent" width="50"><?php echo HTML::link(CLICSHOPPING::link('index.php', 'A&Catalog\Preview&Preview&pID=' . $Qproducts->valueInt('products_id') . '&origin=' . 'stats_products_viewed.php' . '&page=' . $_GET['page']), HTML::image($CLICSHOPPING_Template->getImageDirectory() . 'icons/preview.gif', $CLICSHOPPING_StatsProductsExpected->getDef('text_image_preview'))); ?></td>
...
?>
    <div class="row">
      <div class="col-md-12">
        <div class="col-md-6 float-md-left pagenumber hidden-xs TextDisplayNumberOfLink"><?php echo $Qproducts->getPageSetLabel($CLICSHOPPING_StatsProductsExpected->getDef('text_display_number_of_link')); ?></div>
