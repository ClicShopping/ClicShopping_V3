...
?>
      <tr onMouseOver="rowOverEffect(this)" onMouseOut="rowOutEffect(this)">
        <th scope="row"><?php echo HTML::link(CLICSHOPPING::link('index.php', 'A&Catalog\Preview&Preview&pID=' . $Qproducts->valueInt('products_id') . '&origin=' . 'stats_products_viewed.php' . '?page=' . $_GET['page']), HTML::image($CLICSHOPPING_Template->getImageDirectory() . 'icons/preview.gif',  $CLICSHOPPING_StatsProductsViewed->getDef('text_preview'))); ?></th>
        ...
        <td><?php echo $rows; ?>.</td>
        <td><?php echo HTML::link(CLICSHOPPING::link('index.php', 'A&Catalog\Preview&Preview&pID=' . $Qproducts->valueInt('products_id') . '&origin=' . 'stats_products_viewed.php' . '?page=' . $_GET['page']), $Qproducts->value('products_name')); ?></td>
