    ...
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span class="col-md-4 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_StatsLowStock->getDef('heading_title'); ?></span>
          <span class="col-md-7 text-md-right">
<?php
  if ($CLICSHOPPING_StatsLowStock->is_installed === true) {
    echo HTML::button($CLICSHOPPING_StatsLowStock->getDef('button_stats_low_stock'), null, $CLICSHOPPING_StatsLowStock->link('StatsLowStock&StatsLowStock'), 'success');
  }
?>
        </div>
      </div>
...
?>
  <form name="CustomersCustomersConfigure" action="<?php echo $CLICSHOPPING_StatsLowStock->link('Configure&Process&module=' . $current_module); ?>" method="post">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><?php echo $CLICSHOPPING_StatsLowStock->getDef('dialog_uninstall_title'); ?></h4>
            </div>
...
?>
   <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_StatsLowStock->getConfigModuleInfo($current_module, 'title'); ?></strong></div>
      <div class="adminformTitle">
        <div class="row">
          <div class="separator"></div>
          <div class="col-md-12">
