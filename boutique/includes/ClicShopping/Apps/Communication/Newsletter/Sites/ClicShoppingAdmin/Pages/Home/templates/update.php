 ...
 */
  ...
  $action = (isset($_GET['action']) ? $_GET['action'] : '');
   ...
   echo HTML::form('newsletter', $CLICSHOPPING_Newsletter->link('Newsletter&Update&page=' . $_GET['page']));
            ...
            <div class="row">
              <div class="col-md-5">
                <div class="form-group row">
                  <label for="<?php echo $CLICSHOPPING_Newsletter->getDef('text_newsletter_module'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Newsletter->getDef('text_newsletter_module'); ?></label>
                  <div class="col-md-5">
...
?>
            <div class="row">
              <div class="col-md-5">
                <div class="form-group row">
                  <label for="<?php echo $CLICSHOPPING_Newsletter->getDef('text_newsletter_customers_group'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Newsletter->getDef('text_newsletter_customers_group'); ?></label>
                  <div class="col-md-5">
...
?>
            <div class="row">
              <div class="col-md-5">
                <div class="form-group row">
                  <label for="<?php echo $CLICSHOPPING_Newsletter->getDef('text_newsletter_language'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_Newsletter->getDef('text_newsletter_language'); ?></label>
                  <div class="col-md-5">
          ...
          <div class="adminformTitle">
            <div class="row">
              <div class="col-md-5">
                <div class="form-group row">
                  <div class="col-md-5">
                    <?php echo HTMLOverrideAdmin::textAreaCkeditor('message', 'soft', '750','300',  $nInfo->content); ?>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="alert alert-info">
            ...
            <div class="row">
              <span class="col-md-12">
               <blockquote><i><a data-toggle="modal" data-target="#myModalWysiwyg2"><?php echo $CLICSHOPPING_Newsletter->getDef('text_help_wysiwyg'); ?></a></i></blockquote>
