 ...
 */
  ...
  class PasswordForgotten extends \ClicShopping\OM\PagesActionsAbstract {
    ...
    public function execute() {
      ...
      $CLICSHOPPING_Customers->loadDefinitions('Sites/ClicShoppingAdmin/password_forgotten');

      $QcheckCustomer = $CLICSHOPPING_Customers->db->prepare('select customers_firstname,
                                                               customers_lastname,
                                                               customers_password,
                                                               customers_id,
...
// Crypted password mods - create a new password, update the database and mail it to them
        ...
        $text_password_body = $CLICSHOPPING_Customers->getDef('email_password_reminder_body', ['username' => $QcheckCustomer->value('customers_email_address'),
