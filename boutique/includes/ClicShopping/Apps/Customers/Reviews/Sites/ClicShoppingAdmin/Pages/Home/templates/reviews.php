  ...
  <td>
    <table class="table table-sm table-hover table-striped">
      ...
      <tr class="dataTableHeadingRow">
        <th class="text-md-center" width="1"><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);"/></th>
        <th>&nbsp;</th>
        <th>&nbsp;</th>
        <th>&nbsp;</th>
        ...
        <th class="text-md-center"><?php echo $CLICSHOPPING_Reviews->getDef('table_heading_products_average_rating'); ?></th>
...
?>
            ...
            <td></td>
            <td><?php echo HTML::link(CLICSHOPPING::link('index.php', 'A&Catalog\Preview&Preview&pID=' . $Qreviews->valueInt('reviews_id') . '&origin=' . 'reviews.php' . '&page=' . $_GET['page']), HTML::image($CLICSHOPPING_Template->getImageDirectory() . 'icons/preview.gif', $CLICSHOPPING_Reviews->getDef('icon_preview_comment'))); ?></td>
            ...
            <td class="dataTableContent text-md-center"><?php echo $customer_group['customers_group_name']; ?></td>
            <td class="dataTableContent text-md-center"><?php echo DateTime::toLong($Qreviews->value('last_modified')); ?>s</td>
            <td class="dataTableContent text-md-center">
<?php
...
?>
    <div class="row">
      <div class="col-md-12">
        <div class="col-md-6 float-md-left pagenumber hidden-xs TextDisplayNumberOfLink"><?php echo $Qreviews->getPageSetLabel($CLICSHOPPING_Reviews->getDef('text_display_number_of_link')); ?></div>
        <div class="float-md-right text-md-right"><?php echo $Qreviews->getPageSetLinks(CLICSHOPPING::getAllGET(array('page', 'info', 'x', 'y'))); ?></div>
      </div>
    </div>
<?php
  } // end $listingTotalRow
