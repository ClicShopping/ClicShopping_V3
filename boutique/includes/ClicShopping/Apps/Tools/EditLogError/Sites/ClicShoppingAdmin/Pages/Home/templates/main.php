...
?>
  <div class="contentBody">
    ...
    <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_EditLogError->getDef('text_edit_log_error') ; ?></strong></div>
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-12 text-md-center">
            <div class="form-group">
              <div class="col-md-12">
<?php
  echo HTML::form('configure', CLICSHOPPING::link('index.php', 'A&Tools\EditLogError&Configure'));
