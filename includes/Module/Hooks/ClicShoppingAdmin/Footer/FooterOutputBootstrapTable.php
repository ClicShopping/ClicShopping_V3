...
//export
      $output .= '<script defer src="https://unpkg.com/bootstrap-table@1.22.2/dist/extensions/export/bootstrap-table-export.min.js"></script>' . "\n";
      $output .= '<script defer src="https://unpkg.com/tableexport.jquery.plugin/tableExport.min.js"></script>' . "\n";
//mobile
      $output .= '<script defer src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-table/1.22.2/extensions/mobile/bootstrap-table-mobile.min.js"></script>' . "\n";
      $output .= '
<script defer>
  window.icons = {
