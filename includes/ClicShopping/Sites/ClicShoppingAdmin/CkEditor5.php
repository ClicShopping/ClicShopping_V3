 ...
 */
  ...
  class CkEditor5 extends HTML
  {
    ...
    public static function getJsCkEditor() :string
    {
      ...
      $script = '<script src="https://cdn.ckeditor.com/ckeditor5/' . $version . '/' . $type . '/ckeditor.js"></script><br />' . "\n";

      if ($code != 'en') {
        if(!empty($code)) {
          $script .= '<script src="https://cdn.ckeditor.com/ckeditor5/' . $version . '/classic/translations/' . $code . '.js"></script><br />' . "\n";
        }
      }
    ...
    {
      $cript = '<script src="' . HTTP::getShopUrlDomain() . 'ext/elFinder-master/js/elfinder.min.js"></script>' . "\n";
 ...
 //     $connector = CLICSHOPPING::getConfig('dir_root', 'Shop') . 'ext/elFinder-master/php/connector.minimal.php';
      $connector = HTTP::getShopUrlDomain()  . 'ext/elFinder-master/php/connector.minimal.php';

      //$connector = 'localhost/clicshopping_test/ext/elFinder-master/php/connector.minimal.php';
