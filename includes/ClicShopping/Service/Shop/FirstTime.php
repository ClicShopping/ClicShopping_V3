  ...
  class FirstTime implements \ClicShopping\OM\ServiceInterface
  {
    ...
    public static function start()
    {
      ...
      if (WEBSITE_MODULE_INSTALLED == 0) {
        echo TEXT_INSTALL;
        echo '   <div class="text-md-center;"><br /><a href="https://www.clicshopping.org/marketplace" target="_blank"><img src="images/logo_clicshopping.webp" border="0" height="100" width="100" alt="Market Place"><br />Go to Market Place</a></div>';
