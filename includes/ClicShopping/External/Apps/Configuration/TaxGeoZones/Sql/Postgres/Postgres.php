...
namespace ClicShopping\Apps\Configuration\TaxGeoZones\Sql\Postgres;
...
class Postgres
{
  ...
  private static function installDb()
  {
    ...
    $Qcheck = $CLICSHOPPING_Db->query("SELECT to_regclass(':table_geo_zones')");
...
EOD;
    ...
    $Qcheck = $CLICSHOPPING_Db->query("SELECT to_regclass(':table_zones_to_geo_zones')");
...
CREATE TABLE :table_zones_to_geo_zones (
  ...
  last_modified timestamp,
  date_added timestamp NOT NULL,
  CONSTRAINT idx_zones_to_geo_zones_country_id UNIQUE (zone_country_id)
);
EOD;
      $CLICSHOPPING_Db->exec($sql);
    }
