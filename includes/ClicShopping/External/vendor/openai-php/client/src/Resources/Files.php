...
final class Files implements FilesContract
{
    ...
    public function list(): ListResponse
    {
        ...
        /** @var Response<array{object: string, data: array<int, array{id: string, object: string, created_at: int, bytes:  int|null, filename: string, purpose: string, status: string, status_details: array<array-key, mixed>|string|null}>}> $response */
    ...
    public function retrieve(string $file): RetrieveResponse
    {
        ...
        /** @var Response<array{id: string, object: string, created_at: int, bytes:  int|null, filename: string, purpose: string, status: string, status_details: array<array-key, mixed>|string|null}> $response */
        $response = $this->transporter->requestObject($payload);
