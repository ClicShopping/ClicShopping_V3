...
class Install extends \ClicShopping\OM\PagesActionsAbstract
{
  public function execute()
  {
    ...
    $CLICSHOPPING_Recommendations->loadDefinitions('Sites/ClicShoppingAdmin/install');

    $m = Registry::get('RecommendationsAdminConfig' . $current_module);
    $m->install();

    static::installDbMenuAdministration();
    static::installProductsRecommendationsDb();

    $CLICSHOPPING_MessageStack->add($CLICSHOPPING_Recommendations->getDef('alert_module_install_success'), 'success');
   ...
   *
   */
  private static function installProductsRecommendationsDb(): void
  {
    $CLICSHOPPING_Db = Registry::get('Db');
