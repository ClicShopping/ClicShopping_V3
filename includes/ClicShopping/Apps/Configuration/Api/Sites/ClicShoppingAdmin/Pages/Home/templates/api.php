...
<div class="contentBody">
    ...
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span class="col-md-7 text-end"><?php echo HTML::button($CLICSHOPPING_Api->getDef('button_insert'), null, $CLICSHOPPING_Api->link('Edit'), 'success') . ' '; ?>
          </span>
        </div>
      </div>
    </div>
  ...
  <table
    ...
    <tr>
      ...
      <th data-field="username" data-sortable="true"><?php echo $CLICSHOPPING_Api->getDef('table_heading_api_username'); ?></th>
      <th data-field="key" class="text-center"><?php echo $CLICSHOPPING_Api->getDef('table_heading_api_key_text'); ?></th>
      <th data-field="status" data-sortable="true" class="text-center"><?php echo $CLICSHOPPING_Api->getDef('table_heading_api_status'); ?></th>
      <th data-field="date_added" data-sortable="true" class="text-center"><?php echo $CLICSHOPPING_Api->getDef('table_heading_api_date_added'); ?></th>
      <th data-field="date_modified" data-sortable="true" class="text-center"><?php echo $CLICSHOPPING_Api->getDef('table_heading_api_date_modified'); ?></th>
      <th data-field="action" data-switchable="false" class="text-end"><?php echo $CLICSHOPPING_Api->getDef('table_heading_action'); ?>&nbsp;</th>
    </tr>
    </thead>
    <tbody>
    <?php
