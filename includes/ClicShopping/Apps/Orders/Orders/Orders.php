...
class Orders extends \ClicShopping\OM\AppAbstract
{
  ...
  public function getConfigModules(): mixed
  {
    ...
    if (!isset($result)) {
      ...
      $name_space_config = 'ClicShopping\Apps\Orders\Orders\Module\ClicShoppingAdmin\Config';
      $trigger_message = 'ClicShopping\Apps\Orders\Orders\Orders::getConfigModules(): ';
