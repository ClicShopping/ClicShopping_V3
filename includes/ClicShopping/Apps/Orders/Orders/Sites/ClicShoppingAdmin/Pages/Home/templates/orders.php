...
?>
  ...
  <table
    ...
    <tr>
      <th data-field="orders" data-sortable="true"><?php echo $CLICSHOPPING_Orders->getDef('table_heading_orders'); ?>&nbsp;</th>
      <th data-field="customers" data-sortable="true"><?php echo $CLICSHOPPING_Orders->getDef('table_heading_customers'); ?>&nbsp;</th>
