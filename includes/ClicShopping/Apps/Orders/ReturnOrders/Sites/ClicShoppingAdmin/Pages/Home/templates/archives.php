...
<div class="contentBody">
  ...
  <div id="toolbar" class="float-end">
    <button id="button" class="btn btn-danger"><?php echo $CLICSHOPPING_ReturnOrders->getDef('button_delete'); ?></button>
  </div>
  ...
  <table
    ...
    <thead class="dataTableHeadingRow">
      <tr>
        ...
        <th data-field="selected" data-sortable="true" data-visible="false" data-switchable="false"><?php echo $CLICSHOPPING_ReturnOrders->getDef('table_heading_return_orders_id'); ?></th>
        <th data-switchable="false"></th>
        <th data-field="ref" data-sortable="true"><?php echo $CLICSHOPPING_ReturnOrders->getDef('table_heading_return_orders_ref'); ?></th>
        <th data-field="order_id" data-sortable="true"><?php echo $CLICSHOPPING_ReturnOrders->getDef('table_heading_return_orders_order_id'); ?></th>
        <th data-field="customer" data-sortable="true"><?php echo $CLICSHOPPING_ReturnOrders->getDef('table_heading_return_orders_customer'); ?></th>
        <th data-field="model" data-sortable="true"><?php echo $CLICSHOPPING_ReturnOrders->getDef('table_heading_return_orders_model'); ?></th>
        <th data-field="products_name" data-sortable="true" class="text-center"><?php echo $CLICSHOPPING_ReturnOrders->getDef('table_heading_return_orders_products_name'); ?></th>
        <th data-field="status" data-sortable="true" class="text-center"><?php echo $CLICSHOPPING_ReturnOrders->getDef('table_heading_return_orders_status'); ?></th>
        <th data-field="opened" data-sortable="true" class="text-center"><?php echo $CLICSHOPPING_ReturnOrders->getDef('table_heading_return_orders_date_opened'); ?></th>
        <th data-field="added" data-sortable="true" class="text-center"><?php echo $CLICSHOPPING_ReturnOrders->getDef('table_heading_return_orders_date_added'); ?></th>
        <th data-field="modified" data-sortable="true" class="text-center"><?php echo $CLICSHOPPING_ReturnOrders->getDef('table_heading_return_orders_date_modified'); ?></th>
        <th data-field="action" data-switchable="false" class="text-end"><?php echo $CLICSHOPPING_ReturnOrders->getDef('table_heading_return_orders_action'); ?>&nbsp;</th>
      </tr>
    </thead>
    <tbody>
    <?php
