...
<div class="contentBody">
  ...
  <div id="RecommendationsTabs" style="overflow: auto;">
    <ul class="nav nav-tabs flex-column flex-sm-row" role="tablist" id="myTab">
      <li class="nav-item"><a href="#tab1" role="tab" data-bs-toggle="tab" class="nav-link active"><?php echo $CLICSHOPPING_Recommendations->getDef('tab_analytics'); ?></a></li>
    </ul>
              ...
              <div class="col-md-12">
                <div class="row">
                  <span class="alert alert-info">
                    <i class="bi bi-question-circle" title="<?php echo $CLICSHOPPING_Recommendations->getDef('text_help'); ?>"></i> <?php echo $CLICSHOPPING_Recommendations->getDef('text_help'); ?>
