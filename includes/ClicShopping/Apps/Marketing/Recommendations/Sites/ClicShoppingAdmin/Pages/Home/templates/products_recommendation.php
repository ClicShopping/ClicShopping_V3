...
<div class="contentBody">
  ...
  <div id="toolbar" class="float-end">
    <button id="button" class="btn btn-danger"><?php echo $CLICSHOPPING_Recommendations->getDef('button_delete'); ?></button>
  </div>
  ...
  <table
    ...
    <thead class="dataTableHeadingRow">
      <tr>
        ...
        <th data-field="selected" data-sortable="true" data-visible="false" data-switchable="false"><?php echo $CLICSHOPPING_Recommendations->getDef('id'); ?></th>
        <th data-switchable="false">&nbsp;</th>
        <th data-field="products" data-sortable="true"><?php echo $CLICSHOPPING_Recommendations->getDef('table_heading_products'); ?></th>
          <?php
            if (MODE_B2B_B2C == 'True') {
          ?>
          ...
          ?>
        <th data-field="price" data-sortable="true"><?php echo $CLICSHOPPING_Recommendations->getDef('table_heading_products_price'); ?></th>
        <th data-field="status" data-sortable="true" class="text-center"><?php echo $CLICSHOPPING_Recommendations->getDef('table_heading_status'); ?></th>
        <th data-field="action"  data-switchable="false" class="text-end"><?php echo $CLICSHOPPING_Recommendations->getDef('table_heading_action'); ?>&nbsp;</th>
      </tr>
    </thead>
    <tbody>
<?php
  ...
  ?>
    <tr>
      ...
      ?>
        <td class="text-start"><?php echo $CLICSHOPPING_Currencies->format($Qrecommendations->valueDecimal('products_price')); ?></td>
