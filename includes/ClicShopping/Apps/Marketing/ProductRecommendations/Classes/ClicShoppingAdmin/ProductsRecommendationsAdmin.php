<?php
  ...
  namespace ClicShopping\Apps\Marketing\ProductRecommendations\Classes\ClicShoppingAdmin;

  use ClicShopping\OM\Registry;

  class ProductsRecommendationsAdmin
  {
    protected mixed $db;
     ...
     * @return float
     */
    public static function calculateRecommendationScoreWithMultipleSources(float $productsRateWeight = 0.8, float $reviewRate = 0, ?float $userFeedback = 0): float
    {
     ...
     * @return float
     */
    public static function calculateRecommendationScoreBasedOnRange(float $productsRateWeight = 0.8, float $reviewRate = 0, ?float $userFeedback = 0, ?float $feedbackWeight = 0.2) :float
    {
      // Normalize the user feedback to a value between -1 and 1
      $userFeedback = static::calculateUserFeedbackScore($userFeedback);
