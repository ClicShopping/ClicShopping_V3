 ...
 */
  ...
  class ProductRecommendationsShop
  {
     ...
     */
    public static function saveProductRecommendations(int $products_id, float $reviewRate = 0): void
    {
      ...
      $products_rate_weight = $CLICSHOPPING_ProductsRecommendationsAdmin->calculateProductsRateWeight($products_id);
      ...
      $score = $CLICSHOPPING_ProductsRecommendationsAdmin->calculateRecommendationScore($products_rate_weight, $reviewRate, null, CLICSHOPPING_APP_PRODUCT_RECOMMENDATIONS_PR_STRATEGY);
     ...
     * @return array
     */
    private function getProductRecommendations(int $products_id) :array
    {
