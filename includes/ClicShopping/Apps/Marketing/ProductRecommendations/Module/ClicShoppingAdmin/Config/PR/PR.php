<?php
  ...
  namespace ClicShopping\Apps\Marketing\ProductRecommendations\Module\ClicShoppingAdmin\Config\PR;

  class PR extends \ClicShopping\Apps\Marketing\ProductRecommendations\Module\ClicShoppingAdmin\Config\ConfigAbstract
  {
    ...
    protected function init()
    {
      ...
      $this->is_installed = \defined('CLICSHOPPING_APP_PRODUCT_RECOMMENDATIONS_PR_STATUS') && (trim(CLICSHOPPING_APP_PRODUCT_RECOMMENDATIONS_PR_STATUS) != '');
    }
