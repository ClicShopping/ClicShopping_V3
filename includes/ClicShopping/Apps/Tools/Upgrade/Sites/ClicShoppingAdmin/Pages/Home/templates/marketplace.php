...
<div class="contentBody" xmlns="http://www.w3.org/1999/html">
  ...
  <div class="col-md-12">
    ...
    <div style="height: 700px;">
      <div class="col-md-12">
        <div class="row">
          <div class="alert alert-warning text-center" role="alert"><?php echo $CLICSHOPPING_Upgrade->getDef('text_marketplace_username'); ?></div>
        </div>
    ...
    ?>
      <div style="height: 700px;">
        <div class="col-md-12">
          <div class="row">
            <div class="alert alert-info text-center" role="alert"><?php echo $CLICSHOPPING_Upgrade->getDef('text_marketplace_info'); ?></div>
          </div>
          <div class="text-center">
            <?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . 'marketplace.png', $CLICSHOPPING_Upgrade->getDef('heading_title')); ?>
          </div>
        ...
        <div class="col-md-3 mb-4 d-flex align-items-stretch">
          <div class="card">
            <div class="card-header">
              <div class="col-md-12">
                <div class="row">
                  ...
                  <span class="col-md-3 text-end"><?php echo HTML::stars($Qfilesinformation->valueInt('file_rating')); ?></span>
              ...
              <div class="col-md-12 card-text">
                <div class="row">
                  <span class="col-md-12">
                     ...
                     echo '&nbsp;&nbsp;';
                     ?>
                    <i class="bi bi-box-arrow-up-right text-primary" data-bs-toggle="modal" data-bs-target="#ModalLongDescription<?php echo $i; ?>" title="<?php echo $CLICSHOPPING_Upgrade->getDef('button_more_infos'); ?>"></i>
                    <div class="modal fade" id="ModalLongDescription<?php echo $i; ?>" tabindex="-1" aria-labelledby="ModalLongDescription" aria-hidden="true">
                ...
                <div class="row">
                  <span class="col-md-12 text-center">
                    ...
                    ?>
                    <div class="modal fade" id="myModalImage<?php echo $i; ?>" tabindex="-1" aria-labelledby="myModalImage" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-body">
                            <p id="myModal<?php echo $i; ?>">
                            <img src="<?php echo $Qfilesinformation->value('file_url_screenshot'); ?>" class="img-fluid"  alt="<?php echo $Qfilesinformation->value('file_name'); ?>">
                            </p>
                          </div>
                        </div>
                      </div>
            ...
            <div class="card-footer">
              <span class="col-md-12">
                <span class="row">
                  <span class="col-md-4"><?php echo HTML::button($CLICSHOPPING_Upgrade->getDef('button_more_infos'), null, $value['file_url'], 'primary', ['params' => 'target="_blank"'], 'sm'); ?></span>
