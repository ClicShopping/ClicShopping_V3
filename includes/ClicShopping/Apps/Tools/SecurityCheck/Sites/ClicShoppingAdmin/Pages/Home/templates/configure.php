    ...
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span
            class="col-md-7 text-md-right"><?php echo HTML::button($CLICSHOPPING_SecurityCheck->getDef('button_security_check'), null, $CLICSHOPPING_SecurityCheck->link('SecurityCheck'), 'success'); ?></span>
        </div>
      </div>
    </div>
  </div>
