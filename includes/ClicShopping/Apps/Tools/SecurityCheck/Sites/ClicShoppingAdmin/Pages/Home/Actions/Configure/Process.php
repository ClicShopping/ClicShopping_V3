...
class Process extends \ClicShopping\OM\PagesActionsAbstract
{
  public function execute()
  {
    ...
    foreach ($m->getParameters() as $key) {
      ...
      if (isset($_POST[$p])) {
        $CLICSHOPPING_SecurityCheck->saveCfgParam($key, $_POST[$p]);
      }
    }

    $CLICSHOPPING_MessageStack->add($CLICSHOPPING_SecurityCheck->getDef('alert_cfg_saved_success'), 'success', 'SecurityCheck');
