...
<div class="contentBody">
  ...
  <div id="toolbar" class="float-end">
    <button id="button" class="btn btn-danger"><?php echo $CLICSHOPPING_SecurityCheck->getDef('button_delete'); ?></button>
  </div>
    <table
      id="table"
      data-toggle="table"
      ...
      <thead class="dataTableHeadingRow">
        <tr>
          ...
          <th data-field="status_shop" data-sortable="true" class="text-center"><?php echo $CLICSHOPPING_SecurityCheck->getDef('table_heading_status_shop'); ?></th>
          <th data-field="status_admin" data-sortable="true" class="text-center"><?php echo $CLICSHOPPING_SecurityCheck->getDef('table_heading_status_admin'); ?></th>
          <th data-field="count" data-sortable="true" class="text-center"><?php echo $CLICSHOPPING_SecurityCheck->getDef('table_heading_count'); ?></th>
          <th data-field="action" data-switchable="false" class="text-end"><?php echo $CLICSHOPPING_SecurityCheck->getDef('table_heading_action'); ?></th>
        </tr>
      </thead>
      <tbody>
      <?php
