  ...
  <div id="toolbar" class="float-end">
    ...
    <table
      ...
      <tr>
        ...
        <td>
          <?php
          if ($QIpRestriction->valueInt('ip_status') == 1) {
            echo HTML::link($CLICSHOPPING_SecurityCheck->link('IpRestriction&SetFlag&flag=0&cID=' . $QIpRestriction->valueInt('id')), '<i class="bi-check text-success"></i>');
          } else {
            echo HTML::link($CLICSHOPPING_SecurityCheck->link('IpRestriction&SetFlag&flag=1&cID=' . $QIpRestriction->valueInt('id')), '<i class="bi bi-x text-danger"></i>');
          }
          ?>
        </td>
