...
if (!$CLICSHOPPING_Customer->isLoggedOn()) {
  ...
  <a data-bs-toggle="modal"
     data-bs-target="#loginModal"><?php echo CLICSHOPPING::getDef('modules_header_multi_template_account_login'); ?></a> |
                ...
                <div class="modal-body text-center">
                  ...
                  <div>
                    ...
                    <span class="text-end col-md-6"><label
                        for="<?php echo CLICSHOPPING::getDef('modules_header_multi_template_account_login'); ?>"><?php echo $login; ?></label></span>
                  </div>
                  <?php echo $endform; ?>
                </div>
              </div>
        ...
        <span class="col-md-6 float-start headerMultiTemplateDefaultHeaderSearch">
          ...
          <div class="input-group col-md-12 advancedSearchCriteria">
            <label for="inputKeywordsSearchLogin" class="visually-hidden"></label>
              ...
              <span id="buttonKeywordsSearch"><label
                  for="buttonKeywordsSearch"><?php echo HTML::button(null, 'bi bi-search', null, 'primary', null, 'sm'); ?></label></span>
          </div>
           <div
             class="text-center advancedSearchLink"><?php echo HTML::link(CLICSHOPPING::link(null, 'Search&AdvancedSearch'), CLICSHOPPING::getDef('modules_header_multi_template_title_advanced_search')); ?></div>
          <?php echo HTML::hiddenField('search_in_description', '1'); ?>
          <?php echo $endform; ?>
        </span>
        <span
          class="col-md-6 float-end headerMultiTemplateDefaultShoppingCartImage"><?php echo $banner_header; ?></span>
      </span>
  </div>
  <div class="row">
...
if ($CLICSHOPPING_ShoppingCart->getCountContents() > 0) {
  ...
  <ul>
          <li class="dropdown headerMultiTemplateDefaultShoppingCart">
            <a class="dropdown-toggle headerMultiTemplateDefaultShoppingCart" data-bs-toggle="dropdown"
               href="#"><?php echo '<i class="bi bi-cart-fill headerMultiTemplateDefaultShoppingCart" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;' . $shopping_cart ?></a>
...
?>
                ...
                <li class="headerMultiTemplateDefaultLi">&nbsp;&nbsp;
                  <span
                    class="float-start"><?php echo CLICSHOPPING::getDef('modules_header_multi_template_shopping_cart_total_content'); ?></span>
                  <span
                    class="float-end text-end"><?php echo $CLICSHOPPING_Currencies->format($CLICSHOPPING_ShoppingCart->show_total()); ?></span>
                </li>
                <li role="separator" class="h-divider"></li>
                <li class="headerMultiTemplateDefaultLi">
                  ...
                  <span class="float-end headerMultiTemplateDefaultCheckout"><i
                      class="bi bi-arrow-right-square-fill"></i>&nbsp;&nbsp;<?php echo HTML::link(ClicShopping::link(null, 'Checkout&Shipping'), CLICSHOPPING::getDef('modules_header_multi_template_shopping_cart_checkout')); ?></span>
                </li>
              </ul>
            </li>
         </ul>
