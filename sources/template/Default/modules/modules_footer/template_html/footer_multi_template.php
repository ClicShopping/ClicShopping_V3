...
<br />
    <label for="buttonLogOff"><a class="btn btn-danger btn-sm btn-block" role="button" href="<?php echo CLICSHOPPING::link(null, 'Account&Logoff') ?>"><i class="bi bi-box-arrow-right"></i><?php echo CLICSHOPPING::getDef('module_footer_multi_template_account_box_logoff') ?></a></label>
<?php
  } else {
?>
    ...
    <li class="col-md-12"><br /><label for="buttonLogIn"><a class="btn btn-success btn-sm btn-block" role="button" href="<?php echo CLICSHOPPING::link(null, 'Account&LogIn'); ?>"><i class="bi bi-box-arrow-in-right"></i> <?php echo CLICSHOPPING::getDef('module_footer_multi_template_account_box_login') ?></a></label></li>
<?php
  }
?>
      </ul>
...
?>
              <li><a aria-label="Facebook" href="<?php echo $facebook_url;?>" target="_blank" rel="noopener"><i class="bi bi-facebook"></i></a></li>
<?php
  }
  if (!empty($twitter_url)) {
?>
              <li><a aria-label="Twitter" href="<?php echo $twitter_url;?>" target="_blank" rel="noopener"><i class="bi bi-twitter"></i></a></li>
<?php
  }
/*
...
?>
  ...
  <div class="col-md-<?php echo $content_width; ?>">
    <div class="footerTemplateBox footerTemplateContact">
      ...
      <ul class="list-unstyled">
        <li><label for="buttonFooterContactUs"><?php echo HTML::button(CLICSHOPPING::getDef('module_footer_multi_template_contact_us_email_link'), 'bi bi-person-lines-fill', 'index.php?Info&Contact', 'info'); ?></label></li>
      </ul>
    </div>
  </div>
</div>