            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-footer text-muted d-flex justify-content-start align-items-center p-3">
                        <div class="col-md-12">
                            <div class="row">
                                <textarea class="form-control" id="message" rows="4" placeholder="<?php echo CLICSHOPPING::getDef('module_footer_chatbot_gpt_prompt'); ?>"></textarea>
                                <label class="form-label" for="message"></label>
                            </div>
                            <div class="row">
                                <span class="col-md-6"><button class="btn btn-sm btn-primary btn-send" onclick="sendMessage()"><?php echo CLICSHOPPING::getDef('module_footer_chatbot_gpt_send'); ?></button></span>
                                <span class="col-md-6 text-end"><button class="btn btn-sm btn-danger" id="close-button" onclick="closeChatbox()"><?php echo CLICSHOPPING::getDef('module_footer_chatbot_gpt_close'); ?></button></span>
                            </div>
                        </div>
                    </div>
                </div>
