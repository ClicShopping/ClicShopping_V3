...
<div class="col-md-<?php echo $content_width; ?>">
  <div class="col-md-12">
    ...
    <div class="page-title moduleCheckoutConfirmationCustomersCommentPageHeader"><h3><?php echo CLICSHOPPING::getDef('module_checkout_confirmation_customers_comment_heading_order_title'); ?></h3></div>
