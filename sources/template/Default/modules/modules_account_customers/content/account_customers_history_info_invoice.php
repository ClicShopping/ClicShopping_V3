...
<div class="col-md-<?php echo $content_width; ?>">
  ...
  <div class="card">
    <div class="card-header"><strong><?php echo CLICSHOPPING::getDef('module_account_customers_history_info_invoice_order_number', ['order_id' => (int)$_GET['order_id']]) . ' <span class="badge float-end">' . $CLICSHOPPING_Order->info['orders_status'] . '</span>'; ?></strong></div>
