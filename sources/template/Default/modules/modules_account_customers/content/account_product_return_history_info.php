...
<div class="col-md-<?php echo $content_width; ?>" id="productReturnHistoryInfo">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="page-title Account_CustomersReturn"><h3><?php echo CLICSHOPPING::getDef('module_account_product_return_history_info_heading_title_info'); ?></h3></div>
    </div>
  </div>
<?php
/*
...
?>
  ...
  <div class="row" id="productReturnSummary">
    <div class="col-md-12"><h5><?php echo CLICSHOPPING::getDef('module_account_product_return_history_summary')?></h5></div>
    <div class="separator"></div>
    <div class="separator"></div>
    <div class="col-md-12">
...
*/
  ...
  <div class="row" id="productReturnHistoryInfoComment">
    <div class="col-md-12"><h5><?php echo CLICSHOPPING::getDef('module_account_product_return_history_write_comment')?></h5></div>
    <div class="separator"></div>
    <div class="col-md-12">
      <div class="row">
    ...
    <div class="col-md-12">
      <div class="row">
        <span class="col-md-6"><?php echo HTML::button(CLICSHOPPING::getDef('module_account_product_return_history_button_back'), null, CLICSHOPPING::link(null, 'Account&ProductReturnHistory'), 'primary'); ?></span>
        <span class="col-md-6 text-end"><?php echo HTML::button(CLICSHOPPING::getDef('module_account_product_return_history_button_send'), null, null, 'success'); ?></span>
      </div>
    </div>
  </div>
  <?php echo $endform; ?>
