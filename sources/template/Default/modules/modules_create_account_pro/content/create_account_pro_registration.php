              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6 col-md-6">
                  <div class="btn-group" role="group" aria-label="buttonGroup">
                    <span><?php echo HTML::inputField('password', null, 'required aria-required="true" autocomplete="off" id="inputPassword" aria-describedby="' . CLICSHOPPING::getDef('entry_password') . '" placeholder="' . CLICSHOPPING::getDef('entry_password') . '" minlength="'. ENTRY_PASSWORD_PRO_MIN_LENGTH .'"', 'password'); ?></span>
